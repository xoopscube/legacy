...
define("_MD_FILEGENER","O arquivo de modelo para este tema não existe. Pode ser gerado (copiado do tema <strong>default</strong>), enviado ao servidor, ou importado do diretório <strong>themes</strong>.");
define("_MD_FILEHTML","HTML");
define("_MD_FILEIMPORT","Existe um arquivo antigo, não importado, no diretório <strong>themes</strong>.");
define("_MD_FILEMOD","Ultima atualização (arquivo)");
define("_MD_FILENAME","Nome do arquivo");
define("_MD_FILENEWER","Existe um arquivo novo, ainda não importado, no diretório <strong>themes</strong>.");
