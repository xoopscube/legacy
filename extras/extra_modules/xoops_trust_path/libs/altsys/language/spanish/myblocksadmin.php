...
define('_MD_A_MYBLOCKSADMIN_PERMUPDATED', 'Los permisos se actualizaron con éxito') ;
define('_MD_A_MYBLOCKSADMIN_BLOCKADMIN', 'Administración de Bloques') ;
...
define('_MD_A_MYBLOCKSADMIN_WEIGHT', 'Ubicación') ;
...
define('_MD_A_MYBLOCKSADMIN_FMT_TAGRULE', '%s será reemplazada en %s en esta vista') ;
...
define('_MD_A_MYBLOCKSADMIN_ACTION', 'Acción') ;
define('_MD_A_MYBLOCKSADMIN_DESCRIPTION', 'Descripción') ;
define('_MD_A_MYBLOCKSADMIN_TOPPAGE', 'Página de inicio') ;
define('_MD_A_MYBLOCKSADMIN_ALLPAGES', 'En todas') ;
define('_MD_A_MYBLOCKSADMIN_PERMFORM', 'Permisos') ;
define('_MD_A_MYBLOCKSADMIN_PERM_MADMIN', 'permiso de administración del módulo') ;
define('_MD_A_MYBLOCKSADMIN_PERM_MREAD', 'permiso de lectura del módulo') ;
define('_MD_A_MYBLOCKSADMIN_DBUPDATED', 'La base de datos se actualizó con éxito') ;
define('_MD_A_MYBLOCKSADMIN_FMT_REMOVEBLOCK', '%s será eliminado. ¿Está seguro?') ;
...
define('_MD_A_MYBLOCKSADMIN_LINK_FORCECLONE', 'Forzar la duplicación') ;
...
define('_MD_A_MYBLOCKSADMIN_PERMADDNG', 'No fue posible añadir %s permisos a %s para el grupo %s');
define('_MD_A_MYBLOCKSADMIN_PERMADDOK', 'Añadidos %s permisos para %s para el grupo %s');
define('_MD_A_MYBLOCKSADMIN_PERMRESETNG', 'No es posible restablecer los permisos de grupo para el módulo %s');
