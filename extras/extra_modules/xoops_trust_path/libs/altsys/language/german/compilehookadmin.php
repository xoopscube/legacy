...
define( '_TPLSADMIN_CNF_DELETEOK' , 'Wirklich Löschen?' ) ;
...
define( '_TPLSADMIN_FMT_MSG_PUTTEMPLATES' , '%d Templates wurde importiert.' ) ;
...
define( '_TPLSADMIN_ERR_NOTUPLOADED' , 'Es wurden keine Daten hochgeladen.' ) ;
define( '_TPLSADMIN_ERR_EXTENSION' , 'Die Dateierweiterung konnte nicht erkannt werden.' ) ;
define( '_TPLSADMIN_ERR_INVALIDARCHIVE' , 'Das Archiv kann nicht entpackt werden.' ) ;
