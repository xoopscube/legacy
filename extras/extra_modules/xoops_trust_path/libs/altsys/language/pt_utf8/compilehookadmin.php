...
define("_TPLSADMIN_DT_HOOKSAVEVARS","Inserir sequências lógicas para coletar as variáveis do modelo");
define("_TPLSADMIN_DT_PUTTEMPLATES","Enviar os modelos");
define("_TPLSADMIN_DT_REMOVEHOOKS","Normalizar compilação dos caches dos modelos");
...
define("_TPLSADMIN_FMT_MSG_ENCLOSEBYCOMMENT","%d os caches dos modelos foram delimitados pelos comentários do tplsadmin");
