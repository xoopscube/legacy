...
define('_MD_LECAT_LANG_SET_ID', 'Set ID');
define('_MD_LECAT_LANG_SET', 'Category Set');
...
define('_MD_LECAT_TIPS_CATEGORY_SET','<p>Lecat is category management module.<br />This means many other module like forum, news and article use lecat for their category management.<br /></P<p>Lecat provides two main function to other modules.<ul><li>Category List(tree like)</li><li>Permission check for each category.</li></ul></p><h3>Category Set</h3><p>Each module request different category. For example, a news module requests \'site update\', \'new member\', \'new shop\'. On the other hand, a forum request \'question\', \'request\', \'talk\'.<br />So, you can create several category sets. For news, for forum, for ...</p><p>At first, you create this Category Set.</p>');
...
define('_MD_LECAT_MESSAGE_CONFIRM_SET_DELETE', 'Are you sure to delete ? All of categories belonging to this category set are deleted too.');
