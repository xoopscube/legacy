...
define("_MD_LECAT_ERROR_REQUIRED","{0} é um valor necessário.");
...
define("_MD_LECAT_ERROR_MIN","Entrada {0} com {1} ou maior valor numérico.");
define("_MD_LECAT_ERROR_MAX","Entrada {0} com {1} ou menor valor numérico.");
define("_MD_LECAT_ERROR_OBJECTEXIST","Entrada incorreta em {0}.");
define("_MD_LECAT_ERROR_DBUPDATE_FAILED","Falha na atualização do banco de dados.");
...
define("_MD_LECAT_LANG_ADD_A_NEW_CAT","Criar uma nova categoria");
...
define("_MD_LECAT_LANG_P_ID","Categoria Parent ID");
...
define("_MD_LECAT_ERROR_CONTENT_IS_NOT_FOUND","O conteúdo não foi encontrado");
define("_MD_LECAT_LANG_ADD_A_NEW_SET","Adicionar uma nova categoria Set");
...
define("_MD_LECAT_DESC_PERMISSION_TYPE","Defina o tipo de permissão e os valores padrão.");
define("_MD_LECAT_LANG_ADD_A_NEW_PERMISSION_TYPE","Adicionar um novo tipo de permissão");
...
define("_MD_LECAT_LANG_DELEET_ALL_PERMIT","Remover todas as permissões para esta categoria");
define("_MD_LECAT_LANG_PERMISSION_ON","Permitido");
define("_MD_LECAT_LANG_LEVEL_UNLIMITED","profundidade ilimitada");
define("_MD_LECAT_TIPS_CATEGORY_SET","<p> Lecat é módulo de gerenciamento de categoria. <br /> Isso significa módulo de muitos outros, como fórum, notícias e Lecat utilizar o artigo para o seu gerenciamento por categoria. <br /> </P> <p> Lecat fornece duas funções principais a outros módulos. <ul> <li> List (Categoria como árvore) </li> <li> verificação de permissão para cada categoria. </li> </ul> </p> <h3> Categoria Set </h3> Cada categoria pedido módulo diferente. nova loja membro nova atualização, por exemplo, uma notícia pedidos módulo 'site', '', '. Por outro lado, causa um pedido de fórum ',' pedido ', falar'. <br /> Assim, você pode criar conjuntos de categorias diversas. Para mais notícias, para o fórum, para ...</p> <p> Na primeira, você criar este conjunto de categorias.</p>");
...
define("_MD_LECAT_MESSAGE_CONFIRM_SET_DELETE","Tem certeza que deseja apagar? Todas as categorias pertencentes a esta categoria de jogos são excluídos também.");
define("_MD_LECAT_TIPS_PERMISSIONS","Deixar as permissões a seguir é como se você deseja herdar permissões da categoria pai.");
?>