...
class Lecat_Permission
{
    ...
    public $mActionArr = array();
    public $mPermit = array();    //$mPermit['value'][groupid][key]
     ...
     */
    public function setPermissions($permissionsArr)
    {
     ...
     */
    public function checkPermitGroup($g, $t)
    {
     ...
     */
    public function getPermitKeyGroup($g)
    {
