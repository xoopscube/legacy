...
class xoops_block_check
{
    public $_TOKEN_NAME = 'block';
    public $_mid        = 0;
    public $_is_special = false;
    public $_msg_array  = array();
    public $_error_flag = false;
    public $_xoops_version = '2.0';
    public $_use_token     = false;

//---------------------------------------------------------
// constructor
//---------------------------------------------------------
public function xoops_block_check()
{
...
// private
//--------------------------------------------------------
public function _check_block_by_module(&$module_obj)
{
    ...
    public function _check_block_by_obj(&$info, &$block_obj)
    {
    ...
    public function _remove_block_by_mid($mid)
    {
        $error = false;
    ...
    public function _build_url_module_update($dirname)
    {
...
// module handler
//--------------------------------------------------------
public function &_get_module_objects()
{
    ...
    public function &_get_module_object_by_mid($mid)
    {
        $module_handler =& xoops_gethandler('module');
...
public function _create_token()
{
    ...
    public function _validate_token()
    {
        $token_handler =& xoops_gethandler('SingleToken');
...
public function get_xoops_version()
{
    ...
    public function _detect_xoops_version()
    {
        // very easy way
