...
define('_US_ALLOWVIEWEMAIL', 'Να είναι εμφανής η ηλεκτρονική μου διεύθυνση στα άλλα μέλη');
...
define('_US_REGISTERNG', 'Δεν ήταν δυνατή η εγγραφή νέου μέλους.');
...
define('_US_NOEDITRIGHT', "Λυπούμεθα αλλά δεν έχετε δικαίωμα αλλαγής των στοιχείων αυτού του μέλους.");
...
define('_US_MYAVATAR', 'Το avatar μου');
define('_US_UPLOADMYAVATAR', 'Ανέβασμα avatar');
define('_US_MAXPIXEL', 'Μέγιστος αρiθμός pixels');
define('_US_MAXIMGSZ', 'Μέγιστο μέγεθος avatar (σε bytes)');
