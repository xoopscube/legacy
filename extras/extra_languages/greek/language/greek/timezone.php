...
define("_TZ_GMT0", "(GMT) Greenwich Mean Time, London, Dublin");
define("_TZ_GMTP1", "(GMT+1:00) Amsterdam, Berlin, Rome, Copenhagen, Brussels");
define("_TZ_GMTP2", "(GMT+2:00) Athens, Minsk, Helsinki, Jerusalem, South Africa");
...
define("_TZ_GMTP8", "(GMT+8:00) Beijing, Perth, Singapore, Hong Kong, Taipei");
define("_TZ_GMTP9", "(GMT+9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk");
define("_TZ_GMTP95", "(GMT+9:30) Adelaide, Darwin");
define("_TZ_GMTP10", "(GMT+10:00) Brisbane, Canberra, Melbourne, Sydney");
define("_TZ_GMTP11", "(GMT+11:00) Magadan, Solomon Islands, New Caledonia");
define("_TZ_GMTP12", "(GMT+12:00) Auckland, Wellington, Fiji, Kamchatka ");
