...
if (!defined('_CM_TITLE')) {
    ...
    define('_CM_DOHTML', ' Ενεργοποιημένα HTML Tags');
    define('_CM_DOAUTOWRAP', 'Auto wrap lines');
    define('_CM_DOXCODE', 'Ενεργοποιημένα XOOPS Codes');
    define('_CM_REFRESH', 'Ανανέωση');
    define('_CM_PENDING', 'Σε εκκρεμότητα');
    define('_CM_HIDDEN', 'Κρυφό');
    define('_CM_ACTIVE', 'Ενεργό');
    define('_CM_STATUS', 'Κατάσταση');
    define('_CM_POSTCOMMENT', 'Αποστολή Σχολίου');
    define('_CM_REPLIES', 'Απαντήσεις');
...
define('_CM_UPDATED', 'Ενημερώθηκε');
    ...
    define('_CM_JOINED', 'Μέλος από');
    define('_CM_POSTS', 'Καταχωρήσεις');
    define('_CM_FROM', 'Περιοχή');
    define('_CM_COMDELETED', 'Το σχόλιο ή τα σχόλια διαγράφτηκαν. ');
    define('_CM_COMDELETENG', 'Δεν μπορεί να διαγραφεί το σχόλιο.');
    define('_CM_DELETESELECT', 'Να διαγραφούν όλα τα σχόλια που το χαρακτηρίζουν?');
