<?php
// Translation Info
// $Id: global.php 1139 2012-03-09 17:46:17Z mikhail $
// ############################################################### //
...
define("_ALL","Todos");
define("_ALLOWEDCHAR","Número máximo de caracteres permitidos:");
...
define("_IMAGEMIME","Formato da imagem:");
define("_IMAGENAME","Nome:");
define("_IMGDISPLAY","Mostrar esta imagem?");
...
define("_IMGPOSRORL","'R' para direita (right), 'L' para esquerda (left), ou apenas deixe em branco.");
define("_IMGWEIGHT","Ordem da visualização das imagens:");
define("_INFO","Informações");
define("_INSTALL","Instalar");
define("_LEFT","Esquerda");
define("_LIST","Listar");
define("_LOGIN","Entrar");
define("_LOGOUT","Sair do portal");
...
define("_MINUTE","Um minuto");
define("_MINUTES","%s minutos");
define("_MODULENOEXIST","O módulo selecionado ainda não foi instalado.");
define("_MONTH","Um mês");
define("_MORE","mais...");
define("_MULTIPAGE","Para que o seu texto seja dividido em várias páginas, escreva o código: [pagebreak] - incluindo os colchetes.");
define("_MUSTWABLE","O arquivo %s deve ter permissão de escrita pelo servidor.");
define("_NESTED","Ocultar");
define("_NEWESTFIRST","Novas primeiro");
define("_NO","Não");
define("_NOCACHE","Sem cache");
define("_NOCOMMENTS","Ocultar comentários");
define("_NONE","Nenhum");
define("_NOPERM","Lamento, você ainda não tem permissão para acessar esta área.");
define("_NOTITLE","Sem título");
define("_NUMIMAGES","%s imagens");
define("_OLDESTFIRST","Antigas primeiro");
define("_ON","em");
define("_ONLINEPHRASE","%s visitante(s) presente(s)");
define("_ONLINEPHRASEX","%s na seção %s");
...
define("_READS","leituras internas");
define("_REGISTER","Cadastrar");
define("_REPLY","Responder");
define("_RETURN_TOP","Topo");
define("_RIGHT","Direita");
define("_SEARCH","Pesquisa");
define("_SECOND","Um segundo");
