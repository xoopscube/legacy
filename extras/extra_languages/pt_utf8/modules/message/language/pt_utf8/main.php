...
define("_MD_MESSAGE_FAVORITES1","Falha ao acrescentar.");
...
define("_MD_MESSAGE_SETTINGS_MSG12","{0} foi acrescentado à lista de ignorados.");
define("_MD_MESSAGE_SETTINGS_MSG13","Falha ao acrescentar {0} à lista de ignorados.");
