...
define("_MI_FILEMANAGER_DEBUGON_DSC", "Ativar ou não o modo de depuração (<q>debug</q>) do gerenciador de arquivos, o qual é mostrado em uma página encapsulada (<q><i>iFrame</i></q>).");
...
define("_MI_FILEMANAGER_PATH", "O caminho padrão para a gestão de arquivos");
