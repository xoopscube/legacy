...
define("_MD_AM_BADEMAILS","Escreva os endereços de e-mail que não devem ser utilizados pelos associados");
...
define("_MD_AM_BADUNAMES","Escreva os nomes que não devem ser utilizados para nome de associado");
