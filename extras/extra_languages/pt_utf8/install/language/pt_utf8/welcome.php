<?php
// $Id: welcome.php,v 1.2 2008/10/12 04:29:04 minahito Exp $
...
XOOPS Cube Legacy  é ideal para a criação de portais, sites de notícias, intranets ou weblogs, de pequena a grande escala. O XOOPS Cube Legacy é lançado sob os termos da licença <a href='http://xoopscube.sourceforge.net/license/GPL_V2.txt' target='_blank'>GNU (GPL)</a>.
</p>
<u><b>Requisitos:</b></u>
<p>
<ul>
<li>Servidor web (<a href='http://www.lighttpd.net/' target='_blank'>Lighttpd</a>, <a href='http://www.apache.org/' target='_blank'>Apache</a>, IIS, Roxen, etc).</li>
<li><a href='http://www.php.net/' target='_blank'>PHP</a> 4.3.2 ou superior.</li>
<li>Banco de dados <a href='http://www.mysql.com/' target='_blank'>MySQL</a> v3.23.XX.</li>
</ul>
</p>
...
// <li>Muitos aplicativos de segurança da Internet, firewall ou antivírus podem impedir que o instalador do XOOPS Cube funcione da forma correta.</li>
?>