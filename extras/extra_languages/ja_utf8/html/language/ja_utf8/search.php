...
define('_SR_FOUND','<b>%s</b>件のデータが見つかりました。');
define('_SR_SHOWING','（%d 〜 %d 件目を表示）');
define('_SR_ANY','いずれか（OR検索）');
define('_SR_ALL','すべて（AND検索）');
define('_SR_EXACT','フレーズ');
...
define('_SR_KEYIGNORE', '文字数が <b>%s</b> 文字未満のキーワードは無視されます。');
