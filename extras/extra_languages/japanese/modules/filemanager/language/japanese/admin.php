...
define('_AD_FILEMANAGER_CONFIRMMSSAGE', "アップロード可能なサイズは %sまでです。");
...
define('_AD_FILEMANAGER_ADDFOLDER_CONFIRMMSSAGE', "%s の下にフォルダを作成します。作成するフォルダ名を入力して下さい。");
...
define('_AD_FILEMANAGER_SWF_INSTALL_FLASH', "SWFUpload  ライブラリをロード出来ません。ライブラリがセットされているか確認するか、Flash プレイヤーをインストールして下さい。<br />
こちらから <a href=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\">Adobe website</a>Flash プレイヤーをインストールして下さい");
