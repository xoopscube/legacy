...
define('_MSC_AVAVATARS','アバター一覧');
define('_MSC_SMILIES','顔アイコン');
define('_MSC_CLICKASMILIE','画像をクリックすると顔アイコン(スマイリー)を本文に追加することができます。');
define('_MSC_CODE','顔文字');
define('_MSC_EMOTION','意味');
?>