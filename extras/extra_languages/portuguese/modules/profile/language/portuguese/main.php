...
// ******************************************************************** //
define("_MD_PROFILE_DESC_OPTIONS","Opções separadas com barras verticais (<i>pipes</i>), sem espaços extras. Exemplo: café|chá verde|guaraná|ritalina");
...
define("_MD_PROFILE_LANG_FIELD_TIP1","<i>String</i> (Seqüência) - permite uma série de caracteres a ser armazenado");
define("_MD_PROFILE_LANG_FIELD_TIP2","Texto - textarea com editor");
define("_MD_PROFILE_LANG_FIELD_TIP3","Int (inteiros) - valor de entrada que contenha apenas dígitos decimais");
define("_MD_PROFILE_LANG_FIELD_TIP4","Data - assim como o próprio nome diz, pode especificar uma data");
