...
define("_MB_USER_GUESTS","An�nimos");
...
define("_MB_USER_NODISPGR","N�o mostrar os associados cuja gradua��o �:");
define("_MB_USER_ONLINEPHRASE","H� %s visitantes neste momento...");
define("_MB_USER_ONLINEPHRASEX","%s na se��o %s"); //
define("_MB_USER_PASSWORD","Senha:");
define("_MB_USER_REMEMBERME","Lembrar");
define("_MB_USER_SECURE","Entrar via conex�o segura");
