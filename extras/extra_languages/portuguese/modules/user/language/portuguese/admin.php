<?php
// $Id: admin.php 957 2011-06-15 01:05:27Z mikhail $
...
define("_AD_USER_LANG_AVATAR_UPDATECONF","Confirme a atualização do avatar");
define("_AD_USER_LANG_AVATAR_UPLOAD","Envio em lote de avatares");
define("_AD_USER_LANG_AVATAR_UPLOAD_FILE","Arquivo comprimido de avatares (somente nos formatos tar.gz ou zip)");
define("_AD_USER_LANG_AVATAR_UPLOAD_RESULT","Resultado do envio em lote de avatares");
...
define("_AD_USER_LANG_FOUNDUSERS","Total de associados com essas características:");
...
define("_AD_USER_TIPS_DATA_DOWNLOAD","O arquivo CSV com os dados dos associados só está disponível em ordem de cadastro (<q>user_id</q>).");
