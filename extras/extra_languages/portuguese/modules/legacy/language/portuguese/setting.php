...
N -> Representaзгo numйrica ISO-8601 do dia da semana (adicionado no PHP 5.1.0) 1 (para Segunda) atй 7 (para Domingo)
...
SEMANA --- ---
W -> Nъmero do ano da semana ISO-8601, semanas comeзam na Segunda (adicionado no PHP 4.1.0) Exemplo: 42 (the 42nd week in the year)
...
o -> Nъmero do ano ISO-8601. Este tem o mesmo valor como Y, exceto que se o nъmero da semana ISO (W) pertence ao anterior ou prуximo ano, o ano й usado ao invйs. (adicionado no PHP 5.1.0) Exemplos: 1999 ou 2003
...
P -> Diferenзa para Greenwich time (GMT) com dois pontos entre horas e minutos (adicionado no PHP 5.1.3) Exemplo: +02:00
