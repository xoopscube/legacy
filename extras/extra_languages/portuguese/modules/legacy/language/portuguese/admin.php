...
define("_AD_LEGACY_ERROR_DELETE_MODULEINFO_FROM_DB","Não foi possível remover as informações do módulo do banco de dados utilizado pelo XOOPS Cube 2.2.");
...
define("_AD_LEGACY_ERROR_REQUIRED","{0} é um valor necessário.");
...
define("_AD_LEGACY_MESSAGE_UNINSTALLATION_MODULE_SUCCESSFUL","O módulo <samp>{0}</samp> foi desinstalado corretamente.");
...
define("_AD_LEGACY_PHPSETTING_DE","Mostrar erros"); // Neste caso, a palavra debug pode ser escrita como "mostrar erros" porque realmente não vai além disso, não é um "modo de depuração" altamente "verbose"
define("_AD_LEGACY_PHPSETTING_DOM","Extensão <i>Dom</i>");
define("_AD_LEGACY_PHPSETTING_EXIF","Extensão <i>Exif</i>");
...
define("_MD_AM_DEBUGMODEDSC","Diversos tipos de depuração de comportamento (<q>debug</q>). Usado quando o portal ainda está em desenvolvimento para tratar erros.");
...
define("_MD_AM_SENDMAILPATHDESC","Caminho físico (<i>path</i>) do programa <i>SendMail</i> (ou substituto compatível) no servidor.");
