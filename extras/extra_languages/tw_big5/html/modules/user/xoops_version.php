<?php
// $Id: xoops_version.php,v 1.1 2008/03/09 02:26:17 minahito Exp $
//  ------------------------------------------------------------------------ //
...
$modversion['templates'][1]['description'] = '在 userinfo.php 顯示使用者資訊';

$modversion['templates'][2]['file'] = 'user_userform.html';
$modversion['templates'][2]['description'] = '顯示登入及註冊頁';

$modversion['templates'][3]['file'] = 'user_edituser.html';
$modversion['templates'][3]['description'] = '編輯個人資料時顯示的頁面';
