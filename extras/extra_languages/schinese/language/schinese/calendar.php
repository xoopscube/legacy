...
define("_CAL_TGL1STD", "每周首日");
define("_CAL_PREVYR", "前一年(适用于菜单)");
define("_CAL_PREVMNTH", "前一月(适用于菜单)");
define("_CAL_GOTODAY", "今天");
define("_CAL_NXTMNTH", "下一月(适用于菜单)");
define("_CAL_NEXTYR", "下一年(适用于菜单)");
