...
define("_TZ_GMTM8", "(GMT-8:00) Pacific Time (��� &amp; ������)");
define("_TZ_GMTM7", "(GMT-7:00) Mountain Time (��� &amp; ������)");
define("_TZ_GMTM6", "(GMT-6:00) Central Time (��� &amp; Canada), ������");
define("_TZ_GMTM5", "(GMT-5:00) ��������� ����� (��� &amp; ������), Bogota, Lima, Quito");
define("_TZ_GMTM45", "(GMT-4:30) Caracas");
define("_TZ_GMTM4", "(GMT-4:00) ������������� ����� (������), �������, La Paz");
define("_TZ_GMTM35", "(GMT-3:30) �����������");
define("_TZ_GMTM3", "(GMT-3:00) ��������, Buenos Aires, Georgetown");
define("_TZ_GMTM2", "(GMT-2:00) Mid-Atlantic");
define("_TZ_GMTM1", "(GMT-1:00) �������� �������, Cape Verde Islands");
...
define("_TZ_GMTP9", "(GMT+9:00) ������������, �����, ����, �����, �������, ������");
define("_TZ_GMTP95", "(GMT+9:30) Adelaide, Darwin");
define("_TZ_GMTP10", "(GMT+10:00) ���������, �����������, ����������� �� �����");
