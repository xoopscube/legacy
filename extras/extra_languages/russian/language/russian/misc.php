...
define("_MSC_ENTERYNAME", "Пожлауйста, введите ваше имя");
define("_MSC_ENTERFNAME", "Пожалуйста, введите имя вашего друга");
define("_MSC_ENTERFMAIL", "Пожалуйста, введите Email вашего друга");
define("_MSC_NEEDINFO", "Вам необходимо ввести требующуюся информацию!");
define("_MSC_INVALIDEMAIL1", "Email адрес, который Вы ввели не является валидным.");
define("_MSC_INVALIDEMAIL2", "Пожалуйста, проверьтье адрес и попробуйте еще раз.");

define("_MSC_AVAVATARS", "Доступные Аватары");

define("_MSC_SMILIES", "Смайлики");
define("_MSC_CLICKASMILIE", "Щелкните по смайлику чтобы вставить его в свое сообщение.");
