...
define("_SR_NOMATCH", "沒有找到任何符合您要查詢的資料");
//define("_SR_NOMATCH","No Match Found for your Query");

define("_SR_FOUND", "找到 <b>%s</b> 個符合的項目");
...
define('_SR_KEYTOOSHORT', '關鍵字必須至少 <b>%s</b> 個字元長度');
//define('_SR_KEYTOOSHORT', 'Keywords must be at least <b>%s</b> characters long');

define('_SR_KEYIGNORE', '關鍵字少於 <b>%s</b> 個字元者將會被忽略');
...
define('_SR_IGNOREDWORDS', '下列語句(%u 個字元)比規定的最小字元長度還短,它將不會被包含在您的搜尋中:');
