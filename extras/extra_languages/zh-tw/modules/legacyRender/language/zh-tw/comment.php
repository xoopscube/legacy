...
define('_CM_DELETEONE', '不, 只刪除這個評論本身');
//define('_CM_DELETEONE' , 'No, delete only this comment');

define('_CM_DELETEALL', '是的, 全部刪除');
//define('_CM_DELETEALL', 'Yes, delete all');

define('_CM_THANKSPOST', '感謝發表評論!');
//define('_CM_THANKSPOST', 'Thanks for posting!');

define('_CM_NOTICE', '這些評論各由發表者自負責任. 對於他們的發言內容, 本站不提供任何擔保.');
...
define('_CM_COMAPPROVEALL', '評論只要有發表都接受');
//define('_CM_COMAPPROVEALL','Comments are always approved');

define('_CM_COMAPPROVEUSER', '註冊使用者發表的評論都接受');
...
define('_CM_COMANONPOST', '允許匿名發表評論嗎?');
