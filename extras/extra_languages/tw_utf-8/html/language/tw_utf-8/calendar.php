<?php
// $Id: calendar.php,v 1.1 2008/03/09 02:26:04 minahito Exp $
//%%%%%		Time Zone	%%%%
...
define("_CAL_TGL1STD", "每週首日");
define("_CAL_PREVYR", "前一年 (適用於選單)");
define("_CAL_PREVMNTH", "前一月 (適用於選單)");
define("_CAL_GOTODAY", "今日");
define("_CAL_NXTMNTH", "下一月 (適用於選單)");
define("_CAL_NEXTYR", "下一年 (適用於選單)");
define("_CAL_SELDATE", "選擇日期");
define("_CAL_DRAGMOVE", "移除");
define("_CAL_TODAY", "今日");
define("_CAL_DISPM1ST", "星期一為每週首日");
define("_CAL_DISPS1ST", "星期日為每週首日");
