...
define('_AD_LEGACY_TIPS_BLOCK_UNINSTALL', "Lorsque vous désinstallez un bloc, la configuration du bloc n'est pas effacé. Le bloc n'est plus visible. Et vous pouvez l'installer ultérieurement avec votre dernière configuration.");
