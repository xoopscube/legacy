...
if (alterChangeColumn()==false) {
    echo 'unable to alter change column for XCL2.2 upgrade';
    die();
}
if (alterModulesTable()==false) {
    echo 'unable to alter modules table for XCL2.2 upgrade';
    die();
}
if (insertXoopsConfig()==false) {
    echo 'unable to insert cool_uri config for XCL2.2 upgrade';
    die();
}
