...
define("_MD_IMGCATWGRP","Selecionar os grupos que têm permissão de enviar imagens:<BR /><BR /><span style='font-weight: normal;?>Typical usage is for moderator and admin groups.</span>");
...
define("_MD_STRTYOPENG","Esta configuração não pode ser alterada posteriormente.");
define("_MD_INDB","Gravar as imagens no banco de dados (como informação binária 'blob')");
define("_MD_ASFILE","Gravar as imagens como arquivos (no diretório de uploads)<BR />");
