...
@include XOOPS_ROOT_PATH . '/modules/cubeUtils/class/MultiLanguage.class.php';
class MultiLanguagePreLoad extends XCube_ActionFilter
{
    function preFilter()
    {
        if (file_exists(XOOPS_ROOT_PATH.'/modules/cubeUtils/class/MultiLanguage.class.php')) {
            ...
            // Following Global variable is prepared for calling direct filtering function
    ...
    {
        if (defined('CUBE_UTILS_ML_OUTPUT_CHARSET') && !defined('_CHARSET')) {
            define('_CHARSET', CUBE_UTILS_ML_OUTPUT_CHARSET);
        }
        if (defined('CUBE_UTILS_ML_OUTPUT_MULTIBYTE') && !defined('XOOPS_USE_MULTIBYTES')) {
            define('XOOPS_USE_MULTIBYTES', CUBE_UTILS_ML_OUTPUT_MULTIBYTE);
        }
    }
