<?php
// $Id: notification.php,v 1.1 2008/03/09 02:27:24 minahito Exp $
...
define ('_NOT_COMMENTSUBMIT_NOTIFY', '回應評論發布通知');
define ('_NOT_COMMENTSUBMIT_NOTIFYCAP', '當有新的回應評論被發布時通知我.');
define ('_NOT_COMMENTSUBMIT_NOTIFYDSC', '接受通知.');
define ('_NOT_COMMENTSUBMIT_NOTIFYSBJ', '[{X_SITENAME 自動提醒通知] {X_MODULE}模組有 {X_ITEM_TYPE} 的回應評論發布');
