...
define( '_TZ_GMTM5' , '(GMT-5:00) Eastern Time (US &amp; Canada), Bogota, Lima');
...
define( '_TZ_GMT0' , '(GMT) Greenwich Mean Time, London, Dublin, Lisbon, Casablanca');
define( '_TZ_GMTP1' , '(GMT+1:00) Amsterdam, Berlin, Rome, Brussels, Madrid, Paris');
define( '_TZ_GMTP2' , '(GMT+2:00) Athens, Istanbul, Minsk, Jerusalem, South Africa');
...
define( '_TZ_GMTP9' , '(GMT+9:00) Tokyo, Seoul, Palau, Pyongyang');
define( '_TZ_GMTP95' , '(GMT+9:30) Adelaide, Darwin');
define( '_TZ_GMTP10' , '(GMT+10:00) Brisbane, Melbourne, Sydney, Guam, Vlasdiostok');
define( '_TZ_GMTP11' , '(GMT+11:00) Magadan, Solomon Islands, New Caledonia');
define( '_TZ_GMTP12' , '(GMT+12:00) Auckland, Wellington, Fiji, Marshall Island');
