...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
    ...
    // Example: define('XOOPS_ROOT_PATH', 'C:/xampp/htdocs/xcl22b/html');
    define('XOOPS_ROOT_PATH', 'C:/xampp/htdocs/xcl22b/html');
    ...
    define('XOOPS_TRUST_PATH', 'C:/xampp/htdocs/xcl22b/xoops_trust_path');

    // XOOPS Virtual Path (URL)
    // Virtual path to your main XOOPS directory WITHOUT trailing slash
    // Example: define('XOOPS_URL', 'http://localhost/xcl22b/html');
    define('XOOPS_URL', 'http://localhost/xcl22b/html');
