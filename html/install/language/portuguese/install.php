...
define("_INSTALL_L130","O sistema de instalação detectou que o banco de dados já contém tabelas do XOOPS 1.3.x.<br />e vai tentar atualizá-las para o XOOPS Cube.");
...
define("_INSTALL_L141","Agora, o sistema de instalação atualizará cada módulo para funcionar com o XOOPS Cube Legacy.<br />Garanta que enviou todos os arquivos do XOOPS Cube ao seu servidor.<br />Esta ação pode demorar algum tempo para ser finalizada.");
define("_INSTALL_L142","Atualizando os módulos...");
define("_INSTALL_L143","O sistema de instalação atualizará agora a configuração do XOOPS 1.3.x para ser utilizada pelo XOOPS Cube.");
...
define("_INSTALL_L149","O sistema de instalação atualizará agora os comentários feitos na versão XOOPS 1.3.x para serem utilizados no XOOPS Cube Legacy.<br />Esta ação pode demorar algum tempo a ser finalizada.");
define("_INSTALL_L15","Por favor, abra o arquivo mainfile.php e escreva as configurações do BD solicitadas");
define("_INSTALL_L150","O sistema de instalação atualizará agora os emoticons e graduações para serem utilizados no XOOPS Cube.<br />Esta ação pode demorar algum tempo para ser finalizada.");
define("_INSTALL_L151","O sistema de instalação atualizará agora os avatares para serem utilizados no XOOPS Cube.<br />Esta ação pode demorar algum tempo para ser finalizada.");
...
define("_INSTALL_L25","Detectamos a seguinte informação do banco de dados nas suas configurações do arquivo mainfile.php. Por favor, verifique se esses dados estão corretos.");
...
define("_INSTALL_L6","Há uma confusão entre a configuração de XOOPS_ROOT_PATH na linha 31 do arquivo mainfile.php e o diretório raiz (root) detectado.");
