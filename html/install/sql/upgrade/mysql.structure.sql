...
ALTER TABLE groups
    ...
    CHANGE type group_type         varchar(10)          NOT NULL;
...
ALTER TABLE groups_users_link
    CHANGE groupid groupid smallint(5) unsigned  NOT NULL,
    CHANGE uid uid         mediumint(8) unsigned NOT NULL,
    ADD linkid             mediumint(8) unsigned NOT NULL auto_increment PRIMARY KEY FIRST;

DROP TABLE metafooter;

ALTER TABLE modules
    CHANGE mid mid                 smallint(5) unsigned NOT NULL auto_increment,
    CHANGE version version         smallint(5) unsigned NOT NULL default '100',
    CHANGE last_update last_update int(10) unsigned     NOT NULL,
    CHANGE weight weight           smallint(3) unsigned NOT NULL,
    CHANGE isactive isactive       tinyint(1) unsigned  NOT NULL,
    CHANGE hasmain hasmain         tinyint(1) unsigned  NOT NULL,
    CHANGE hasadmin hasadmin       tinyint(1) unsigned  NOT NULL,
    CHANGE hassearch hassearch     tinyint(1) unsigned  NOT NULL,
    ADD trust_dirname              varchar(25)          NOT NULL default '',
    ADD role                       varchar(15)          NOT NULL default '',
    ADD hasconfig                  tinyint(1) unsigned  NOT NULL,
    ADD hascomments                tinyint(1) unsigned  NOT NULL,
    ADD hasnotification            tinyint(1) unsigned  NOT NULL default '0';

ALTER TABLE newblocks
    CHANGE bid bid           mediumint(8) unsigned NOT NULL auto_increment,
    CHANGE mid mid           smallint(5) unsigned  NOT NULL,
    CHANGE func_num func_num tinyint(3) unsigned   NOT NULL,
    DROP position,
    CHANGE title title       VARCHAR(191)          NOT NULL,
    CHANGE side side         tinyint(1) unsigned   NOT NULL,
    CHANGE weight weight     smallint(5) unsigned  NOT NULL,
    CHANGE visible visible   tinyint(1) unsigned   NOT NULL,
    CHANGE isactive isactive tinyint(1) unsigned   NOT NULL,
    ADD template             varchar(50)           NOT NULL default '',
    ADD bcachetime           int(10) unsigned      NOT NULL,
    ADD last_modified        int(10) unsigned      NOT NULL,
    CHANGE type block_type   char(1)               NOT NULL;

ALTER TABLE priv_msgs
    CHANGE msg_id msg_id           mediumint(8) unsigned NOT NULL auto_increment,
    CHANGE from_userid from_userid mediumint(8) unsigned NOT NULL,
    CHANGE subject subject         varchar(191)          NOT NULL,
    CHANGE to_userid to_userid     mediumint(8) unsigned NOT NULL,
    CHANGE msg_time msg_time       int(10) unsigned      NOT NULL,
...
ALTER TABLE smiles
    ...
    CHANGE smile_url smile_url VARCHAR(100)         NOT NULL,
    CHANGE emotion emotion     VARCHAR(75)          NOT NULL,
    ADD display                tinyint(1)           NOT NULL;

ALTER TABLE stories
    CHANGE uid uid             mediumint(8) unsigned NOT NULL,
    CHANGE title title         VARCHAR(191)          NOT NULL,
    CHANGE created created     int(10) unsigned      NOT NULL,
    CHANGE published published int(10) unsigned      NOT NULL,
    CHANGE topicid topicid     smallint(5) unsigned  NOT NULL,
    CHANGE type story_type     VARCHAR(5)            NOT NULL,
    ADD expired                int(10) unsigned      NOT NULL,
    ADD comments               smallint(5) unsigned  NOT NULL;

ALTER TABLE users
    CHANGE uid uid                       mediumint(8) unsigned NOT NULL auto_increment,
    CHANGE user_avatar user_avatar       VARCHAR(30)           NOT NULL default 'blank.gif',
    CHANGE user_regdate user_regdate     int(10) unsigned      NOT NULL,
    CHANGE user_icq user_icq             VARCHAR(15)           NOT NULL,
    CHANGE user_from user_from           VARCHAR(100)          NOT NULL,
    CHANGE user_sig user_sig             tinytext              NOT NULL,
    CHANGE user_viewemail user_viewemail tinyint(1) unsigned   NOT NULL,
    CHANGE actkey actkey                 VARCHAR(8)            NOT NULL,
    CHANGE user_aim user_aim             VARCHAR(18)           NOT NULL,
    CHANGE user_yim user_yim             VARCHAR(25)           NOT NULL,
    CHANGE user_msnm user_msnm           VARCHAR(100)          NOT NULL,
    CHANGE posts posts                   mediumint(8) unsigned NOT NULL,
    CHANGE attachsig attachsig           tinyint(1) unsigned   NOT NULL,
    CHANGE `rank` `rank`                 smallint(5) unsigned  NOT NULL,
    CHANGE level level                   tinyint(3) unsigned   NOT NULL default '1',
    CHANGE last_login last_login         int(10) unsigned      NOT NULL,
    CHANGE uorder uorder                 tinyint(1) unsigned   NOT NULL,
    CHANGE user_occ user_occ             VARCHAR(100)          NOT NULL,
    CHANGE user_intrest user_intrest     VARCHAR(150)          NOT NULL,
    ADD user_mailok                      tinyint(1) unsigned   NOT NULL default '1',
    ADD notify_mode                      tinyint(1)            NOT NULL default '0' after uorder,
    ADD notify_method                    tinyint(1)            NOT NULL default '1' after uorder;
