...
define( '_MI_LEGACYRENDER_CONF_BANNERS_DESC' , 'Note : The Banner Client credentials grant type is used by clients to obtain an access token to banners stats. Client logins and passwords are therefore external to the user group authorization system.');
define( '_MI_LEGACYRENDER_NAME' , 'Render');
define( '_MI_LEGACYRENDER_NAME_DESC' , 'This rendering engine (renderer) is compatibile with XOOPS2-JP and XCL 2.3.x. You can use XOOPS2 Themes with this system.');
