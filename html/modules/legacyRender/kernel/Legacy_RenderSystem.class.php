...
class Legacy_RenderSystem extends XCube_RenderSystem
{
    ...
    function renderTheme(&$target)
    {
        ...
        $assignNameMap = array(
            ...
            XOOPS_CENTERBLOCK_GLOBAL => array('showflag' => 'xoops_showcblock', 'block' => 'xoops_cgblocks')
        );
    ...
    function _getBlockShowFlag($area)
    {
        switch ($area) {
            ...
            case 'xoops_showcblock' :
                ...
                return (!empty($this->mController->mRoot->mContext->mAttributes['legacy_BlockShowFlags'][XOOPS_CENTERBLOCK_GLOBAL]) ||
                    !empty($this->mController->mRoot->mContext->mAttributes['legacy_BlockShowFlags'][XOOPS_CENTERBLOCK_LEFT]) ||
