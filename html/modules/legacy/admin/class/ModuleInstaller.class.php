...
/**
 * This class extends a base class for the process of module install.
 * Some private functions are added.
 *
 * @todo It seems possible to abstract with other installer classes.
 */
