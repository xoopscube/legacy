...
define('LEGACY_ADMIN_BLOCK_SYSTEM_CACHEPREFIX', XOOPS_CACHE_PATH.'/'.urlencode(XOOPS_URL).'_admin_block_system_');
 ...
 * @package legacy
 */
class Legacy_AdminBlockSystem extends Legacy_AbstractBlockProcedure
{
    public $mModules = [];
    ...
    public function execute()
    {
        ...
        $cachePath = LEGACY_ADMIN_BLOCK_SYSTEM_CACHEPREFIX . md5(XOOPS_SALT . "($groups)". $langMgr->mLanguageName).'.html';
        ...
        $render->setTemplateName('legacy_admin_block_dashboardsystem.html');
    ...
    {
        $adminDashboardMenucache = glob(LEGACY_ADMIN_BLOCK_SYSTEM_CACHEPREFIX . '*.html');
