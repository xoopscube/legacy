...
define( '_WAP_BUNDLE_DSC' , "XCL v.2.3.x — это веб-приложение общего назначения с подходом к разработке с минимальным кодом, поддерживаемым на GitHub.
...
define('_WARNINSTALL2', "ВНИМАНИЕ: Каталог {0} существует на Вашем сервере. Удалите его, для обеспечения большей безопасности.");
define('_WARNINWRITEABLE', "ВНИМАНИЕ: Сервер имеет права записи в файл {0}. Измените права для этого файла для обеспечения большей безопасности. для Unix (444), для Win32 (Только-чтение)");
