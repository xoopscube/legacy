...
define( '_WARN_INSTALL_TIP' , 'Включите предварительную загрузку — только в целях разработки!<br>Это позволяет сохранить каталог установки нетронутым.<br>Не забудьте удалить папку «install», чтобы избежать проблем с безопасностью.');
