...
define('_MD_LEGACY_MESSAGE_INSTALL_COMPLETE_CONFIRM', "Η εγκατάσταση ολοκληρώθηκε με επιτυχία!");
define('_MD_LEGACY_MESSAGE_INSTALL_COMPLETE_WARNING', "Διαγράψτε το φάκελο {0} ώστε να αποτρέψετε τους επίδοξους attackers από το να προσπαθήσουν να χρησιμοποιήσουν τον installer. Στη συνέχεια κάντε reload το browser για να προχωρήσετε.");
