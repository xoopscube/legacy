<?php
// Translation Info
// $Id: admin.php 955 2008-10-14 03:47:45Z mikhail.miguel $
...
define("_AD_LEGACY_ERROR_BLOCK_TEMPLATE_INSTALL","Não foi possível instalar o modelo do bloco <q>{0}</q>.");
...
define("_AD_LEGACY_ERROR_COULD_NOT_DELETE_BLOCK_TEMPLATES","Não foi possível remover o modelo do bloco <q>{0}</q>.");
define("_AD_LEGACY_ERROR_COULD_NOT_INSERT_CONFIG","Não foi possível inserir a configuração <q>{0}</q>");
define("_AD_LEGACY_ERROR_COULD_NOT_INSTALL_BLOCK","Não foi possível instalar o bloco <q>{0}</q>.");
define("_AD_LEGACY_ERROR_COULD_NOT_INSTALL_TEMPLATE","Não foi possível instalar o modelo <q>{0}</q>.");
define("_AD_LEGACY_ERROR_COULD_NOT_SET_ADMIN_PERMISSION","Não foi possível definir as permissões administrativas");
define("_AD_LEGACY_ERROR_COULD_NOT_SET_BLOCK_PERMISSION","Não foi possível definir as permissões do bloco <q>{0}</q>");
define("_AD_LEGACY_ERROR_COULD_NOT_SET_LINK","Não foi possível definir link with all module at <q>{0}</q> block");
...
define("_AD_LEGACY_ERROR_DROP_TABLE","Não foi possível remover a tabela <q>{0}</q>");
define("_AD_LEGACY_ERROR_EXTENSION","Lamento, o arquivo enviado possui uma extensão bloqueada pelo portal.");
define("_AD_LEGACY_ERROR_FAILED_TO_EXECUTE_CALLBACK","Erro ao tentar executar <q>{0}</q>");
define("_AD_LEGACY_ERROR_GROUPID","É necessário conceder permissão de acesso a um ou mais grupos.");
define("_AD_LEGACY_ERROR_IMG_FILESIZE","O tamanho máximo para os arquivos de imagem é <q>{0}</q> bytes.");
define("_AD_LEGACY_ERROR_IMG_SIZE","A largura e altura máximas de um arquivo de imagem é <q>{0}</q> x <q>{1}</q>.");
define("_AD_LEGACY_ERROR_INSTALLATION_MODULE_FAILURE","Não foi possível instalar o módulo <q>{0}</q>.");
define("_AD_LEGACY_ERROR_INTRANGE","<q>{0}</q> é um valor inválido.");
define("_AD_LEGACY_ERROR_MIN","Enrada <q>{0:toLower}</q> com <q>{1}</q> ou mais valores numéricos.");
...
define("_AD_LEGACY_ERROR_OBJECTEXIST","Entrada incorreta em <q>{0:toLower}</q>.");
...
define("_AD_LEGACY_ERROR_SQL_FILE_NOT_FOUND","Arquivo SQL não encontrado em <q>{0}</q>");
define("_AD_LEGACY_ERROR_TEMPLATE_UNINSTALLED","Não foi possível desinstalar o modelo <q>{0}</q>.");
define("_AD_LEGACY_ERROR_UNINSTALLATION_MODULE_FAILURE","Lamento, ocorreu um erro ao tentar desinstalar o módulo <q>{0}</q>.");
define("_AD_LEGACY_ERROR_UPDATING_MODULE_FAILURE","Lamento, não foi possível atualizar o módulo <q>{0}</q>.");
...
define("_AD_LEGACY_LANG_ISACTIVE","Habilitar?");
...
define("_AD_LEGACY_LANG_WEIGHT","Peso");
define("_AD_LEGACY_MESSAGE_BLOCK_HAS_BEEN_UNINSTALLED","O bloco <q>{0}</q> foi desinstalado");
define("_AD_LEGACY_MESSAGE_BLOCK_INSTALLED","O bloco <q>{0}</q> foi instalado");
define("_AD_LEGACY_MESSAGE_BLOCK_TEMPLATE_INSTALLED","O modelo do bloco <q>{0}</q> foi instalado corretamente.");
...
define("_AD_LEGACY_MESSAGE_DROP_TABLE","Remoção da tabela: <q>{0}</q>");
define("_AD_LEGACY_MESSAGE_INSERT_CONFIG","Inclusão da configuração: <q>{0}</q>");
define("_AD_LEGACY_MESSAGE_INSTALLATION_MODULE_SUCCESSFUL","O módulo <q>{0}</q> foi instalado corretamente.");
define("_AD_LEGACY_MESSAGE_TEMPLATE_INSTALLED","O modelo <q>{0}</q> foi instalado...");
define("_AD_LEGACY_MESSAGE_UNINSTALLATION_BLOCK_SUCCESSFUL","O bloco <q>{0}</q> foi desinstalado corretamente...");
define("_AD_LEGACY_MESSAGE_UNINSTALLATION_MODULE_SUCCESSFUL","O módulo <q>{0}</q> foi desinstalado corretamente.");
define("_AD_LEGACY_MESSAGE_UPDATE_STARTED","Atualizando...");
define("_AD_LEGACY_MESSAGE_UPDATING_MODULE_SUCCESSFUL","O módulo <q>{0}</q> foi atualizado corretamente.");
...
define("_MD_AM_PREFMAIN","Definições");
...
define("_MD_AM_SENDMAILPATHDESC","Caminho físico (path) do programa <q>sendmail</q> (ou substituto compatível) no servidor.");
