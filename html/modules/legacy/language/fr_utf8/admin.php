...
define( '_AD_LEGACY_LANG_ACTIONSEARCH_INFO' , "Utilisez la recherche avec des mots clés pour vous aider à retrouver une fonction de votre configuration.");
...
define( '_MD_AM_CLOSESITETXT' , "Raison de la fermeture du site");
