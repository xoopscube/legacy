...
define( '_MD_LEGACY_LANG_IMAGE_NICENAME' , 'Nicename');
...
define( '_MD_LEGACY_MESSAGE_INSTALL_COMPLETE_WARNING' , 'Delete the "Installation Wizard" directory to block anonymous attackers trying to use the installer.<br><span class="badge"> {0}</span>');
