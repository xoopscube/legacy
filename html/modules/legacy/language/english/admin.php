...
define( '_AD_LEGACY_LANG_CONFCAT_NAME' , 'Config Category Name');
...
define( '_AD_LEGACY_LANG_CUSTOM_WITH_SMILIES' , 'Custom Smilies');
define( '_AD_LEGACY_LANG_CUSTOM_WITHOUT_SMILIES' , 'Custom Auto Format');
...
define( '_AD_LEGACY_LANG_IMAGE_COUNT' , 'Total');
define( '_AD_LEGACY_LANG_IMAGE_CREATED' , 'Created');
define( '_AD_LEGACY_LANG_IMAGE_DELETE' , 'Image delete');
define( '_AD_LEGACY_LANG_IMAGE_DISPLAY' , 'Display');
...
define( '_AD_LEGACY_LANG_IMAGE_NEW' , 'New Image');
...
define( '_AD_LEGACY_LANG_IMAGE_WEIGHT' , 'Order');
...
define( '_AD_LEGACY_LANG_IMAGECATEGORY_NEW' , 'New Image Category');
...
define( '_AD_LEGACY_LANG_IMGCAT_MAXHEIGHT' , 'Height');
define( '_AD_LEGACY_LANG_IMGCAT_MAXSIZE' , 'Size');
define( '_AD_LEGACY_LANG_IMGCAT_MAXWIDTH' , 'Width');
define( '_AD_LEGACY_LANG_IMGCAT_NAME' , 'Name');
define( '_AD_LEGACY_LANG_IMGCAT_READ_GROUPS' , 'Groups who can view this category.');
define( '_AD_LEGACY_LANG_IMGCAT_STORETYPE' , 'Storetype');
...
define( '_AD_LEGACY_LANG_LAST_MODIFIED' , 'Modified');
...
define( '_AD_LEGACY_LANG_SMILES_NEW' , 'New smiley');
...
define( '_AD_LEGACY_LANG_THEME_ADMIN' , 'Theme Management');
...
define( '_MD_AM_ADMNOTSET' , 'Admin email has not been set.');
...
define( '_MD_AM_CENSOR' , 'Word Censor');
...
define( '_MD_AM_CLOSESITETXT' , '🚧 Maintenance Mode - Message');
define( '_MD_AM_CLOSESITETXTDSC' , 'The text that is presented when the site is closed e.g. Maintenance Mode, Opening Soon, etc.');
define( '_MD_AM_COMMODE' , '💬 Default Comment Display Mode');
define( '_MD_AM_COMORDER' , '💬 Default Comments Display Order');
define( '_MD_AM_DEBUGMODE' , '<a id="debug-mode">🐞 Debug mode</a>');
...
define( '_MD_AM_DOBADIPS' , '<a id="ip-ban">⛔ Enable IP bans?</a>');
...
define( '_MD_AM_DOSEARCH' , 'Enable Global Search');
...
define( '_MD_AM_MAILFROMNAMEDESC' , 'Name of the sender that will appear in outgoing messages');
...
define( '_MD_AM_MINSEARCHDSC' , 'The minimum keyword length required to perform a search');
...
define( '_MD_AM_SEARCH' , 'Global Search');
...
define( '_MD_AM_THEMEFILEDSC' , 'If this option is enabled, module template .html files will be automatically updated if newer files are found in the themes/your_theme/templates directory for the current theme. This option should be turned off once the site goes public.');
