...
define( '_MD_AM_CLOSESITETXT' , '🚧 Message e.g. Maintenance Mode, Opening Soon, etc.');
...
define( '_MD_AM_STARTPAGE' , '📦 Module for your start page; if none, use template front-page.');
