...
define( '_AD_LEGACY_LANG_IMGCAT_MAXHEIGHT' , 'Max. height (px)');
define( '_AD_LEGACY_LANG_IMGCAT_MAXSIZE' , 'Max. size (byte)');
define( '_AD_LEGACY_LANG_IMGCAT_MAXWIDTH' , 'Max. width (px)');
...
define( '_MD_AM_CLOSESITE' , '🚧 Maintenance Mode - Turn your site off?');
...
define( '_MD_AM_DOBADIPS' , '<a id="ip_ban">⛔ Enable IP bans?</a>');
