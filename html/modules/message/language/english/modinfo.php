...
define( '_MI_MESSAGE_SUB_FAVORITES' , 'Favorite Users');
...
define( '_MI_MESSAGE_DELTYPE_DESC' , 'The unread messages are automatically deleted during purge process.');
define( '_MI_MESSAGE_DEFAULT_USEPM' , 'Default setting: Use private message');
define( '_MI_MESSAGE_DEFAULT_USEPM_DESC' , 'Set up "Use private message" by default to all users.');
...
define( '_MI_MESSAGE_DEFAULT_VIEWMSM' , 'Default setting: Include the original message in mail');
define( '_MI_MESSAGE_DEFAULT_VIEWMSM_DESC' , 'Set up "Include the original message in mail" by default to all users.');

define( '_MI_MESSAGE_BLOCK_NAME' , 'New Messages');
define( '_MI_INQUIRY_INSTALL_ERROR' , 'This module only works with PHP7+.');
