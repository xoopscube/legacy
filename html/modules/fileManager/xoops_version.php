...
$modversion['image']	   = file_exists(XOOPS_ROOT_PATH.'/modules/'.$mydirpath.'/images/module_icon.png') ? XOOPS_ROOT_PATH.'/modules/'.$mydirpath.'images/module_icon.png' : XOOPS_ROOT_PATH.'/modules/'.$mydirpath.'module_icon.php' ;
