...
define('_MI_FILEMANAGER_DEBUGON_DSC',"Enable or not the debug console of uploader that is rendered inside an iframe.");
...
define('_MI_FILEMANAGER_EXTENSIONS',"File extensions allowed for upload");
...
define('_MI_FILEMANAGER_FOPT_DSC',"Please specify the command option.（This feature is not available）");
...
define('_MI_FILEMANAGER_FCONVERT_DSC',"Specify the maximum size of files converted to video format FLV. The unit is MB.");
