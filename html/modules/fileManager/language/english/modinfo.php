...
define('_MI_FILEMANAGER_PATH_DSC',"Define an upload path (under /uploads/, without '/')");
...
define('_MI_FILEMANAGER_DEBUGON_DSC',"Enable or not debug console of upload that is rendered inside an iframe.");


define('_MI_FILEMANAGER_XOOPSLOCK',"Hide system images?");
define('_MI_FILEMANAGER_XOOPSLOCK_DSC',"Display or not files from 'Image Manager'.");
...
define('_MI_FILEMANAGER_FCAPTURE_DSC',"Time from the beginning of the video to take a screenshot of the video file(s).");
