...
(function() {
    CKEDITOR.plugins.add("codemirror", {
        lang: "en,fr,ja,pt", // %REMOVE_LINE_CORE%
        version: "1.18.4",
        init: function (editor) {
            ...
            if (requirePresent){
                ...
                pluginRequire = require.config({
                    ...
                    packages: [{
                        ...
                        name: "codemirror-mode-smarty",
                        location: location,
                        main: "codemirror.mode.smarty.min.js"
                    }, {
                    ...
                    bundles: {
                        ...
                        'codemirror-mode-smarty': ["modeSmarty"],
            ...
            if (editor.elementMode === CKEDITOR.ELEMENT_MODE_INLINE || editor.plugins.sourcedialog) {
                ...
                CKEDITOR.dialog.add("sourcedialog", function (editor) {
                    ...
                    function loadCodeMirrorInline(editor, textarea, dialog) {
                        ...
                        if (mode == "php") {
                            mode = { name: "php", base: "text/x-php" };
                        }
                        else if (mode == "smarty") {
                            mode = { name: "smarty", base: "text/html" };
                        }
            ...
            function getCodeMirrorScripts() {
                ...
                switch (config.mode) {
                    ...
                    case "smarty":
                        {
                            scriptFiles.push(rootPath + "js/codemirror.mode.smarty.min.js");
                        }
