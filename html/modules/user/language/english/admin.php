...
define( '_AD_USER_LANG_MAIL_NG_USERS_ONLY' , 'Only users who do not accept mail');
...
define( '_AD_USER_LANG_RANK_LIST' , 'User rank management');
define( '_AD_USER_LANG_RANK_MAX' , 'Maximum posts');
define( '_AD_USER_LANG_RANK_MIN' , 'Minimum posts');
define( '_AD_USER_LANG_RANK_NEW' , 'Add new rank');
...
define( '_AD_USER_LANG_REGDATE' , 'Registered');
...
define( '_AD_USER_LANG_USER_LIST' , 'User management');
define( '_AD_USER_LANG_USER_NEW' , 'Add new user');
define( '_AD_USER_LANG_USER_NEW_FIELD' , 'Add new profile field');
