...
$adminmenu[10]['title'] = _MI_USER_ADMENU_USER_SEARCH;
$adminmenu[10]['keywords'] = _MI_USER_KEYWORD_USER_SEARCH;
$adminmenu[10]['link'] = 'admin/index.php?action=UserSearch';
$adminmenu[10]['show'] = true;

$adminmenu[20]['title'] = _MI_USER_MENU_CREATE_GROUP;
$adminmenu[20]['link'] = 'admin/index.php?action=GroupEdit';
$adminmenu[20]['keywords'] = _MI_USER_KEYWORD_CREATE_GROUP;
$adminmenu[20]['show'] = false;

$adminmenu[30]['title'] = _MI_USER_ADMENU_GROUP_LIST;
$adminmenu[40]['keywords'] = _MI_USER_KEYWORD_GROUP_LIST;
$adminmenu[30]['link'] = 'admin/index.php?action=GroupList';
$adminmenu[30]['show'] = true;

$adminmenu[40]['title'] = _MI_USER_MENU_CREATE_USER;
$adminmenu[40]['link'] = 'admin/index.php?action=UserEdit';
$adminmenu[40]['keywords'] = _MI_USER_KEYWORD_CREATE_USER;
$adminmenu[40]['show'] = false;

$adminmenu[50]['title'] = _MI_USER_ADMENU_LIST;
$adminmenu[50]['keywords'] = _MI_USER_KEYWORD_USER_LIST;
$adminmenu[50]['link'] = 'admin/index.php';
$adminmenu[50]['show'] = true;

$adminmenu[60]['title'] = _MI_USER_MENU_CREATE_RANK;
$adminmenu[60]['link'] = 'admin/index.php?action=RanksEdit';
$adminmenu[60]['keywords'] = _MI_USER_KEYWORD_CREATE_RANK;
$adminmenu[60]['show'] = false;

$adminmenu[70]['title'] = _MI_USER_ADMENU_RANK_LIST;
$adminmenu[70]['link'] = 'admin/index.php?action=RanksList';
