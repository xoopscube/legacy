...
define('_MD_KEYTOOSHORT', 'キーワードは %s 字以上で指定してください。');
define('_MD_KEYIGNORE', '文字数が <strong>%s</strong> 字未満のキーワードは無視されます。');
define('_MD_SEARCHRULE', '検索上の注意');
define('_MD_IGNOREDWORDS', '次の語句は短すぎる(%u 字以下)ため検索に使用されていません。');
define('_MD_UNABLE_TO_SEARCH','検索できるページがありません。');
define('_MD_KEY_WORD_SUG','上のキーワードに類似して下記のキーワードもお試し下さい。');
define('_MD_KEY_SPACE','複数のキーワードで検索する場合は<strong>スペース</strong>で区切って下さい。<br />スペースを含む語句を検索するには検索の種類で「フレーズ」を選択するか、" " で囲んで次のように "空白 含む" としてください。');
