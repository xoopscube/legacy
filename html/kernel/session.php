...
class XoopsSessionHandler
{
    ...
    function write($sess_id, $sess_data)
	{
        ...
        if ( $count > 0 ) {
			...
			$sql = sprintf('INSERT INTO %s (sess_id, sess_updated, sess_ip, sess_data) VALUES (%s, %u, %s, %s)', $this->db->prefix('session'), $sess_id, time(), $this->db->quoteString(xoops_getenv('REMOTE_ADDR')), $this->db->quoteString($sess_data));
        }
