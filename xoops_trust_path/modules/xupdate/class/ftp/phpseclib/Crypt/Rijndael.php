...
class Rijndael extends Base
{
    ...
    function _setupKey()
    {
        ...
        [$dt0, $dt1, $dt2, $dt3] = $this->_getInvTables();
        $temp = $this->w = $this->dw = [];
        ...
        if (!isset($lambda_functions[$code_hash])) {
            switch (true) {
                case $gen_hi_opt_code:
                    ...
                    break;
                default:
                    for ($i = 0, $cw = count((array) $this->w); $i < $cw; ++$i) {
                        $w[]  = '$w['  . $i . ']';
                        $dw[] = '$dw[' . $i . ']';
                    }
            ...
            $lambda_functions[$code_hash] = $this->_createInlineCryptFunction(
                ['init_crypt'    => '', 'init_encrypt'  => $init_encrypt, 'init_decrypt'  => $init_decrypt, 'encrypt_block' => $encrypt_block, 'decrypt_block' => $decrypt_block]
            );
        }
