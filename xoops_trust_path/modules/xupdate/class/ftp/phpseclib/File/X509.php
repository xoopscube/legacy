...
class X509
{
    ...
    */
     ...
     * @access private
     */
    public $DirectoryString = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['teletexString'   => ['type' => ASN1::TYPE_TELETEX_STRING], 'printableString' => ['type' => ASN1::TYPE_PRINTABLE_STRING], 'universalString' => ['type' => ASN1::TYPE_UNIVERSAL_STRING], 'utf8String'      => ['type' => ASN1::TYPE_UTF8_STRING], 'bmpString'       => ['type' => ASN1::TYPE_BMP_STRING]]];
    public $PKCS9String;
    public $AttributeValue = ['type' => ASN1::TYPE_ANY];
    public $Extensions;
    public $KeyUsage = ['type'    => ASN1::TYPE_BIT_STRING, 'mapping' => ['digitalSignature', 'nonRepudiation', 'keyEncipherment', 'dataEncipherment', 'keyAgreement', 'keyCertSign', 'cRLSign', 'encipherOnly', 'decipherOnly']];
    public $ExtKeyUsageSyntax;
    public $BasicConstraints = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['cA'                => ['type'     => ASN1::TYPE_BOOLEAN, 'optional' => true, 'default'  => false], 'pathLenConstraint' => ['type' => ASN1::TYPE_INTEGER, 'optional' => true]]];
    public $KeyIdentifier = ['type' => ASN1::TYPE_OCTET_STRING];
    ...
    public $PrivateKeyUsagePeriod = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['notBefore' => ['constant' => 0, 'optional' => true, 'implicit' => true, 'type' => ASN1::TYPE_GENERALIZED_TIME], 'notAfter'  => ['constant' => 1, 'optional' => true, 'implicit' => true, 'type' => ASN1::TYPE_GENERALIZED_TIME]]];
    public $IssuerAltName;
    public $PolicyMappings;
    public $NameConstraints;

    public $CPSuri = ['type' => ASN1::TYPE_IA5_STRING];
    public $UserNotice;

    public $netscape_cert_type = ['type'    => ASN1::TYPE_BIT_STRING, 'mapping' => ['SSLClient', 'SSLServer', 'Email', 'ObjectSigning', 'Reserved', 'SSLCA', 'EmailCA', 'ObjectSigningCA']];
    public $netscape_comment = ['type' => ASN1::TYPE_IA5_STRING];
    public $netscape_ca_policy_url = ['type' => ASN1::TYPE_IA5_STRING];

    public $Name;
    public $RelativeDistinguishedName;
    public $CRLNumber = ['type' => ASN1::TYPE_INTEGER];
    public $CRLReason = ['type' => ASN1::TYPE_ENUMERATED, 'mapping' => [
        'unspecified',
        'keyCompromise',
        'cACompromise',
        'affiliationChanged',
    ...
    public $InvalidityDate = ['type' => ASN1::TYPE_GENERALIZED_TIME];
    public $CertificateIssuer;
    public $HoldInstructionCode = ['type' => ASN1::TYPE_OBJECT_IDENTIFIER];
    ...
    {
        $this->PKCS9String = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['ia5String'       => ['type' => ASN1::TYPE_IA5_STRING], 'directoryString' => $this->DirectoryString]];

        $AttributeType = ['type' => ASN1::TYPE_OBJECT_IDENTIFIER];

        $AttributeTypeAndValue = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['type' => $AttributeType, 'value'=> $this->AttributeValue]];
        ...
        */
        $this->RelativeDistinguishedName = ['type'     => ASN1::TYPE_SET, 'min'      => 1, 'max'      => -1, 'children' => $AttributeTypeAndValue];
        ...
        $this->Name = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['rdnSequence' => $RDNSequence]];

        // http://tools.ietf.org/html/rfc5280#section-4.1.1.2
        $AlgorithmIdentifier = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['algorithm'  => ['type' => ASN1::TYPE_OBJECT_IDENTIFIER], 'parameters' => ['type'     => ASN1::TYPE_ANY, 'optional' => true]]];
        ...
        */
        $Extension = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['extnId'   => ['type' => ASN1::TYPE_OBJECT_IDENTIFIER], 'critical' => ['type'     => ASN1::TYPE_BOOLEAN, 'optional' => true, 'default'  => false], 'extnValue' => ['type' => ASN1::TYPE_OCTET_STRING]]];
        ...
        $SubjectPublicKeyInfo = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['algorithm'        => $AlgorithmIdentifier, 'subjectPublicKey' => ['type' => ASN1::TYPE_BIT_STRING]]];

        $UniqueIdentifier = ['type' => ASN1::TYPE_BIT_STRING];

        $Time = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['utcTime'     => ['type' => ASN1::TYPE_UTC_TIME], 'generalTime' => ['type' => ASN1::TYPE_GENERALIZED_TIME]]];

        // http://tools.ietf.org/html/rfc5280#section-4.1.2.5
        $Validity = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['notBefore' => $Time, 'notAfter'  => $Time]];

        $CertificateSerialNumber = ['type' => ASN1::TYPE_INTEGER];

        $Version = ['type'    => ASN1::TYPE_INTEGER, 'mapping' => ['v1', 'v2', 'v3']];

        // assert($TBSCertificate['children']['signature'] == $Certificate['children']['signatureAlgorithm'])
        $TBSCertificate = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => [
            // technically, default implies optional, but we'll define it as being optional, none-the-less, just to
            // reenforce that fact
            'version'             => ['constant' => 0, 'optional' => true, 'explicit' => true, 'default'  => 'v1'] + $Version,
            ...
            'issuerUniqueID'       => ['constant' => 1, 'optional' => true, 'implicit' => true] + $UniqueIdentifier,
            'subjectUniqueID'       => ['constant' => 2, 'optional' => true, 'implicit' => true] + $UniqueIdentifier,
            // <http://tools.ietf.org/html/rfc2459#page-74> doesn't use the EXPLICIT keyword but if
            // it's not IMPLICIT, it's EXPLICIT
            'extensions'            => ['constant' => 3, 'optional' => true, 'explicit' => true] + $this->Extensions,
        ]];

        $this->Certificate = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['tbsCertificate'     => $TBSCertificate, 'signatureAlgorithm' => $AlgorithmIdentifier, 'signature'          => ['type' => ASN1::TYPE_BIT_STRING]]];
        ...
        $AnotherName = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['type-id' => ['type' => ASN1::TYPE_OBJECT_IDENTIFIER], 'value'   => ['type' => ASN1::TYPE_ANY, 'constant' => 0, 'optional' => true, 'explicit' => true]]];

        $ExtensionAttribute = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['extension-attribute-type'  => ['type' => ASN1::TYPE_PRINTABLE_STRING, 'constant' => 0, 'optional' => true, 'implicit' => true], 'extension-attribute-value' => ['type' => ASN1::TYPE_ANY, 'constant' => 1, 'optional' => true, 'explicit' => true]]];
        ...
        $BuiltInDomainDefinedAttribute = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['type'  => ['type' => ASN1::TYPE_PRINTABLE_STRING], 'value' => ['type' => ASN1::TYPE_PRINTABLE_STRING]]];
        ...
        $BuiltInStandardAttributes =  ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['country-name'               => ['optional' => true] + $CountryName, 'administration-domain-name' => ['optional' => true] + $AdministrationDomainName, 'network-address'            => ['constant' => 0, 'optional' => true, 'implicit' => true] + $NetworkAddress, 'terminal-identifier'        => ['constant' => 1, 'optional' => true, 'implicit' => true] + $TerminalIdentifier, 'private-domain-name'        => ['constant' => 2, 'optional' => true, 'explicit' => true] + $PrivateDomainName, 'organization-name'          => ['constant' => 3, 'optional' => true, 'implicit' => true] + $OrganizationName, 'numeric-user-identifier'    => ['constant' => 4, 'optional' => true, 'implicit' => true] + $NumericUserIdentifier, 'personal-name'              => ['constant' => 5, 'optional' => true, 'implicit' => true] + $PersonalName, 'organizational-unit-names'  => ['constant' => 6, 'optional' => true, 'implicit' => true] + $OrganizationalUnitNames]];

        $ORAddress = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['built-in-standard-attributes'       => $BuiltInStandardAttributes, 'built-in-domain-defined-attributes' => ['optional' => true] + $BuiltInDomainDefinedAttributes, 'extension-attributes'               => ['optional' => true] + $ExtensionAttributes]];

        $EDIPartyName = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => [
            'nameAssigner' => ['constant' => 0, 'optional' => true, 'implicit' => true] + $this->DirectoryString,
            // partyName is technically required but \phpseclib\File\ASN1 doesn't currently support non-optional constants and
            // setting it to optional gets the job done in any event.
            'partyName'    => ['constant' => 1, 'optional' => true, 'implicit' => true] + $this->DirectoryString,
        ]];

        $GeneralName = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['otherName'                 => ['constant' => 0, 'optional' => true, 'implicit' => true] + $AnotherName, 'rfc822Name'                => ['type' => ASN1::TYPE_IA5_STRING, 'constant' => 1, 'optional' => true, 'implicit' => true], 'dNSName'                   => ['type' => ASN1::TYPE_IA5_STRING, 'constant' => 2, 'optional' => true, 'implicit' => true], 'x400Address'               => ['constant' => 3, 'optional' => true, 'implicit' => true] + $ORAddress, 'directoryName'             => ['constant' => 4, 'optional' => true, 'explicit' => true] + $this->Name, 'ediPartyName'              => ['constant' => 5, 'optional' => true, 'implicit' => true] + $EDIPartyName, 'uniformResourceIdentifier' => ['type' => ASN1::TYPE_IA5_STRING, 'constant' => 6, 'optional' => true, 'implicit' => true], 'iPAddress'                 => ['type' => ASN1::TYPE_OCTET_STRING, 'constant' => 7, 'optional' => true, 'implicit' => true], 'registeredID'              => ['type' => ASN1::TYPE_OBJECT_IDENTIFIER, 'constant' => 8, 'optional' => true, 'implicit' => true]]];

        $GeneralNames = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $GeneralName];

        $this->IssuerAltName = $GeneralNames;

        $ReasonFlags = ['type'    => ASN1::TYPE_BIT_STRING, 'mapping' => ['unused', 'keyCompromise', 'cACompromise', 'affiliationChanged', 'superseded', 'cessationOfOperation', 'certificateHold', 'privilegeWithdrawn', 'aACompromise']];

        $DistributionPointName = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['fullName'                => ['constant' => 0, 'optional' => true, 'implicit' => true] + $GeneralNames, 'nameRelativeToCRLIssuer' => ['constant' => 1, 'optional' => true, 'implicit' => true] + $this->RelativeDistinguishedName]];

        $DistributionPoint = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['distributionPoint' => ['constant' => 0, 'optional' => true, 'explicit' => true] + $DistributionPointName, 'reasons'           => ['constant' => 1, 'optional' => true, 'implicit' => true] + $ReasonFlags, 'cRLIssuer'         => ['constant' => 2, 'optional' => true, 'implicit' => true] + $GeneralNames]];

        $this->CRLDistributionPoints = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $DistributionPoint];

        $this->AuthorityKeyIdentifier = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['keyIdentifier'             => ['constant' => 0, 'optional' => true, 'implicit' => true] + $this->KeyIdentifier, 'authorityCertIssuer'       => ['constant' => 1, 'optional' => true, 'implicit' => true] + $GeneralNames, 'authorityCertSerialNumber' => ['constant' => 2, 'optional' => true, 'implicit' => true] + $CertificateSerialNumber]];

        $PolicyQualifierId = ['type' => ASN1::TYPE_OBJECT_IDENTIFIER];

        $PolicyQualifierInfo = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['policyQualifierId' => $PolicyQualifierId, 'qualifier'         => ['type' => ASN1::TYPE_ANY]]];

        $CertPolicyId = ['type' => ASN1::TYPE_OBJECT_IDENTIFIER];

        $PolicyInformation = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['policyIdentifier' => $CertPolicyId, 'policyQualifiers' => ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 0, 'max'      => -1, 'optional' => true, 'children' => $PolicyQualifierInfo]]];

        $this->CertificatePolicies = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $PolicyInformation];

        $this->PolicyMappings = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['issuerDomainPolicy' => $CertPolicyId, 'subjectDomainPolicy' => $CertPolicyId]]];

        $KeyPurposeId = ['type' => ASN1::TYPE_OBJECT_IDENTIFIER];

        $this->ExtKeyUsageSyntax = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $KeyPurposeId];

        $AccessDescription = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['accessMethod'   => ['type' => ASN1::TYPE_OBJECT_IDENTIFIER], 'accessLocation' => $GeneralName]];

        $this->AuthorityInfoAccessSyntax = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $AccessDescription];

        $this->SubjectInfoAccessSyntax = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $AccessDescription];

        $this->SubjectAltName = $GeneralNames;

        $BaseDistance = ['type' => ASN1::TYPE_INTEGER];

        $GeneralSubtree = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['base'    => $GeneralName, 'minimum' => ['constant' => 0, 'optional' => true, 'implicit' => true, 'default' => new BigInteger(0)] + $BaseDistance, 'maximum' => ['constant' => 1, 'optional' => true, 'implicit' => true] + $BaseDistance]];

        $GeneralSubtrees = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $GeneralSubtree];

        $this->NameConstraints = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['permittedSubtrees' => ['constant' => 0, 'optional' => true, 'implicit' => true] + $GeneralSubtrees, 'excludedSubtrees'  => ['constant' => 1, 'optional' => true, 'implicit' => true] + $GeneralSubtrees]];

        $DisplayText = ['type'     => ASN1::TYPE_CHOICE, 'children' => ['ia5String'     => ['type' => ASN1::TYPE_IA5_STRING], 'visibleString' => ['type' => ASN1::TYPE_VISIBLE_STRING], 'bmpString'     => ['type' => ASN1::TYPE_BMP_STRING], 'utf8String'    => ['type' => ASN1::TYPE_UTF8_STRING]]];

        $NoticeReference = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['organization'  => $DisplayText, 'noticeNumbers' => ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => 200, 'children' => ['type' => ASN1::TYPE_INTEGER]]]];

        $this->UserNotice = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['noticeRef' => ['optional' => true, 'implicit' => true] + $NoticeReference, 'explicitText'  => ['optional' => true, 'implicit' => true] + $DisplayText]];

        // attribute is used in RFC2986 but we're using the RFC5280 definition

        $Attribute = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['type' => $AttributeType, 'value'=> ['type'     => ASN1::TYPE_SET, 'min'      => 1, 'max'      => -1, 'children' => $this->AttributeValue]]];

        $this->SubjectDirectoryAttributes = ['type'     => ASN1::TYPE_SEQUENCE, 'min'      => 1, 'max'      => -1, 'children' => $Attribute];

        // adapted from <http://tools.ietf.org/html/rfc2986>

        $Attributes = ['type'     => ASN1::TYPE_SET, 'min'      => 1, 'max'      => -1, 'children' => $Attribute];

        $CertificationRequestInfo = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['version'       => ['type' => ASN1::TYPE_INTEGER, 'mapping' => ['v1']], 'subject'       => $this->Name, 'subjectPKInfo' => $SubjectPublicKeyInfo, 'attributes'    => ['constant' => 0, 'optional' => true, 'implicit' => true] + $Attributes]];

        $this->CertificationRequest = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['certificationRequestInfo' => $CertificationRequestInfo, 'signatureAlgorithm'       => $AlgorithmIdentifier, 'signature'                => ['type' => ASN1::TYPE_BIT_STRING]]];

        $RevokedCertificate = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['userCertificate'    => $CertificateSerialNumber, 'revocationDate'     => $Time, 'crlEntryExtensions' => ['optional' => true] + $this->Extensions]];

        $TBSCertList = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['version'             => ['optional' => true, 'default'  => 'v1'] + $Version, 'signature'           => $AlgorithmIdentifier, 'issuer'              => $this->Name, 'thisUpdate'          => $Time, 'nextUpdate'          => ['optional' => true] + $Time, 'revokedCertificates' => ['type'     => ASN1::TYPE_SEQUENCE, 'optional' => true, 'min'      => 0, 'max'      => -1, 'children' => $RevokedCertificate], 'crlExtensions'       => ['constant' => 0, 'optional' => true, 'explicit' => true] + $this->Extensions]];

        $this->CertificateList = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['tbsCertList'        => $TBSCertList, 'signatureAlgorithm' => $AlgorithmIdentifier, 'signature'          => ['type' => ASN1::TYPE_BIT_STRING]]];

        $this->IssuingDistributionPoint = ['type' => ASN1::TYPE_SEQUENCE, 'children' => ['distributionPoint'          => ['constant' => 0, 'optional' => true, 'explicit' => true] + $DistributionPointName, 'onlyContainsUserCerts'      => ['type'     => ASN1::TYPE_BOOLEAN, 'constant' => 1, 'optional' => true, 'default'  => false, 'implicit' => true], 'onlyContainsCACerts'        => ['type'     => ASN1::TYPE_BOOLEAN, 'constant' => 2, 'optional' => true, 'default'  => false, 'implicit' => true], 'onlySomeReasons'           => ['constant' => 3, 'optional' => true, 'implicit' => true] + $ReasonFlags, 'indirectCRL'               => ['type'     => ASN1::TYPE_BOOLEAN, 'constant' => 4, 'optional' => true, 'default'  => false, 'implicit' => true], 'onlyContainsAttributeCerts' => ['type'     => ASN1::TYPE_BOOLEAN, 'constant' => 5, 'optional' => true, 'default'  => false, 'implicit' => true]]];

        $this->CertificateIssuer = $GeneralNames;

        $PublicKeyAndChallenge = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['spki'      => $SubjectPublicKeyInfo, 'challenge' => ['type' => ASN1::TYPE_IA5_STRING]]];

        $this->SignedPublicKeyAndChallenge = ['type'     => ASN1::TYPE_SEQUENCE, 'children' => ['publicKeyAndChallenge' => $PublicKeyAndChallenge, 'signatureAlgorithm'    => $AlgorithmIdentifier, 'signature'             => ['type' => ASN1::TYPE_BIT_STRING]]];

        $this->PostalAddress = ['type'     => ASN1::TYPE_SEQUENCE, 'optional' => true, 'min'      => 1, 'max'      => -1, 'children' => $this->DirectoryString];
    }
            ...
            for ($i = 0; $i < count($extensions); $i++) {
                ...
                if (!is_bool($map)) {
                    ...
                    if ($id == 'id-ce-certificatePolicies') {
                        for ($j = 0; $j < (is_countable($value) ? count($value) : 0); $j++) {
                            if (!isset($value[$j]['policyQualifiers'])) {
                                continue;
                            }
                            for ($k = 0; $k < (is_countable($value[$j]['policyQualifiers']) ? count($value[$j]['policyQualifiers']) : 0); $k++) {
        ...
        if (is_array($attributes)) {
            for ($i = 0; $i < count($attributes); $i++) {
                ...
                if (is_array($attributes[$i]['value'])) {
                    ...
                    for ($j = 0; $j < (is_countable($values) ? count($values) : 0); $j++) {
    ...
    function _mapInDNs(&$root, $path, $asn1)
    {
        ...
        if (is_array($dns)) {
            for ($i = 0; $i < count($dns); $i++) {
                for ($j = 0; $j < (is_countable($dns[$i]) ? count($dns[$i]) : 0); $j++) {
                    $type = $dns[$i][$j]['type'];
                    $value = &$dns[$i][$j]['value'];
    ...
    function _validateSignatureCountable($caonly, $count)
    {
        ...
        switch (true) {
            case isset($this->currentCert['tbsCertificate']):
                ...
                if (!empty($this->CAs)) {
                    for ($i = 0; $i < count((array) $this->CAs); $i++) {
                    ...
                    if (count((array) $this->CAs) == $i && $caonly) {
    ...
    function removeDNProp($propName)
    {
        ...
        $size = is_countable($dn) ? count($dn) : 0;
        for ($i = 0; $i < $size; $i++) {
    ...
    function getDNProp($propName, $dn = null, $withType = false)
    {
        ...
        $dn = $dn['rdnSequence'];
        $result = [];
        for ($i = 0; $i < (is_countable($dn) ? count($dn) : 0); $i++) {
            if ($dn[$i][0]['type'] == $propName) {
                $v = $dn[$i][0]['value'];
                if (!$withType) {
                    if (is_array($v)) {
    ...
    function setDN($dn, $merge = false, $type = 'utf8String')
    {
        ...
        for ($i = 1; $i < (is_countable($results) ? count($results) : 0); $i+=2) {
            $prop = trim($results[$i], ', =/');
            $value = $results[$i + 1];
            if (!$this->setDNProp($prop, $value, $type)) {
                return false;
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && (is_countable($subject->domains) ? count($subject->domains) : 0)) {
            $altName = array_map(['\phpseclib\File\X509', '_dnsName'], $subject->domains);
        }

        if (isset($subject->ipAddresses) && (is_countable($subject->ipAddresses) ? count($subject->ipAddresses) : 0)) {
    ...
    function signCSR($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($this->currentCert) && is_array($this->currentCert) && isset($this->currentCert['certificationRequestInfo'])) {
            ...
            $this->currentCert = ['certificationRequestInfo' =>
                ['version' => 'v1', 'subject' => $this->dn, 'subjectPKInfo' => $publicKey], 'signatureAlgorithm' => ['algorithm' => $signatureAlgorithm], 'signature'          => false];
        }
    ...
    function removeAttribute($id, $disposition = self::ATTR_ALL)
    {
        ...
        foreach ($attributes as $key => $attribute) {
            if ($attribute['type'] == $id) {
                $n = is_countable($attribute['value']) ? count($attribute['value']) : 0;
                switch (true) {
    ...
    function _formatSubjectPublicKey()
    {
        if ($this->publicKey instanceof RSA) {
            ...
            return ['algorithm' => ['algorithm' => 'rsaEncryption'], 'subjectPublicKey' => $this->publicKey->getPublicKey(RSA::PUBLIC_FORMAT_PKCS1)];
        }
    ...
    function _revokedCertificate(&$rclist, $serial, $create = false)
    {
        ...
        $rclist[] = ['userCertificate' => $serial, 'revocationDate'  => $this->_timeField($revocationDate->format('D, d M Y H:i:s O'))];
        return $i;
    }
