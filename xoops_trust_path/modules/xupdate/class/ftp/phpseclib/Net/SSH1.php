...
class SSH1
{
     ...
     * Not supported.
     */
    public const CIPHER_IDEA = 1;
    /**
     * DES in CBC mode
     */
    public const CIPHER_DES = 2;
    /**
     * Triple-DES in CBC mode
     *
     * All implementations are required to support this
     */
    public const CIPHER_3DES = 3;
    /**
     ...
     */
    public const CIPHER_BROKEN_TSS = 4;
    /**
     * RC4
     *
     * Not supported.
     ...
     */
    public const CIPHER_BLOWFISH = 6;
    /**#@-*/
    ...
    */
     ...
     */
    public const AUTH_RHOSTS = 1;
    /**
     * pure RSA authentication
     */
    public const AUTH_RSA = 2;
    /**
     * password authentication
     *
     * This is the only method that is supported by this library.
     */
    public const AUTH_PASSWORD = 3;
    /**
     * .rhosts with RSA host authentication
     */
    public const AUTH_RHOSTS_RSA = 4;
    /**#@-*/
    ...
    */
    ...
    public const MASK_LOGIN       = 0x00000004;
    public const MASK_SHELL       = 0x00000008;
    /**#@-*/
    ...
    */
     ...
     * @access private
     */
    public $supported_ciphers = [self::CIPHER_NONE       => 'No encryption', self::CIPHER_IDEA       => 'IDEA in CFB mode', self::CIPHER_DES        => 'DES in CBC mode', self::CIPHER_3DES       => 'Triple-DES in CBC mode', self::CIPHER_BROKEN_TSS => 'TRI\'s Simple Stream encryption CBC', self::CIPHER_RC4        => 'RC4', self::CIPHER_BLOWFISH   => 'Blowfish'];
     ...
     * @access private
     */
    public $supported_authentications = [self::AUTH_RHOSTS     => '.rhosts or /etc/hosts.equiv', self::AUTH_RSA        => 'pure RSA authentication', self::AUTH_PASSWORD   => 'password authentication', self::AUTH_RHOSTS_RSA => '.rhosts with RSA host authentication'];
     ...
     * @access private
     */
    public $protocol_flags = [1  => 'NET_SSH1_MSG_DISCONNECT', 2  => 'NET_SSH1_SMSG_PUBLIC_KEY', 3  => 'NET_SSH1_CMSG_SESSION_KEY', 4  => 'NET_SSH1_CMSG_USER', 9  => 'NET_SSH1_CMSG_AUTH_PASSWORD', 10 => 'NET_SSH1_CMSG_REQUEST_PTY', 12 => 'NET_SSH1_CMSG_EXEC_SHELL', 13 => 'NET_SSH1_CMSG_EXEC_CMD', 14 => 'NET_SSH1_SMSG_SUCCESS', 15 => 'NET_SSH1_SMSG_FAILURE', 16 => 'NET_SSH1_CMSG_STDIN_DATA', 17 => 'NET_SSH1_SMSG_STDOUT_DATA', 18 => 'NET_SSH1_SMSG_STDERR_DATA', 19 => 'NET_SSH1_CMSG_EOF', 20 => 'NET_SSH1_SMSG_EXITSTATUS', 33 => 'NET_SSH1_CMSG_EXIT_CONFIRMATION'];
    ...
    function _get_binary_packet()
    {
        ...
        return [self::RESPONSE_TYPE => $type, self::RESPONSE_DATA => $data];
    }
