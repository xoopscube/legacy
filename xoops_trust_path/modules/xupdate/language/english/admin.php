...
define('_AD_XUPDATE_LANG_NO_OVERWRITE', "Protected files or folders (prefix search). Force overwrite when truen it on this check box.");
define('_AD_XUPDATE_LANG_NO_UPDATE', "Excluded files or folders (prefix search). Force overwrite or upload when truen it on this check box.");
