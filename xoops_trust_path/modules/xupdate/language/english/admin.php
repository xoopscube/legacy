<?php
define( '_AD_XUPDATE_LANG_WRITABLE_RESULT' , 'Check folder permissions');
define( '_AD_XUPDATE_LANG_EXTENSION_CHECK_RESULT' , 'PHP extension check results');
...
define( '_AD_XUPDATE_LANG_NAME' , 'Name');
...
define( '_AD_XUPDATE_LANG_MESSAGE_BATCH_INSTALL' , 'Batch');
...
define( '_AD_XUPDATE_INSTALL_PRE' , 'Pre-installing');
