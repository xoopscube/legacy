...
define( '_MI_XUPDATE_WRITABLE_DIR_PERM' , 'Permission of writable dir (html)');
define( '_MI_XUPDATE_WRITABLE_DIR_PERMDSC' , 'Permission to set the writable dirctory (html side)');
define( '_MI_XUPDATE_WRITABLE_FILE_PERM' , 'Permission of writable file (html)');
define( '_MI_XUPDATE_WRITABLE_FILE_PERMDSC' , 'Permission to set the writable file (html side)');
define( '_MI_XUPDATE_WRITABLE_DIR_PERM_T' , 'Permission of writable dir (trust)');
define( '_MI_XUPDATE_WRITABLE_DIR_PERM_TDSC' , 'Permission to set the writable dirctory (trust side)');
define( '_MI_XUPDATE_WRITABLE_FILE_PERM_T' , 'Permission of writable file (trust)');
