...
define('_AD_XUPDATE_LANG_NO_OVERWRITE', "上書きしないファイルまたはディレクトリ(前方一致)。<br />チェックを入れると該当するアイテムを強制上書きします。<br />該当するアイテムが配置先に存在しない場合はチェック状態に関わらず配置されます。");
define('_AD_XUPDATE_LANG_NO_UPDATE', "アップデート時に配置または上書きしないファイルまたはディレクトリ(前方一致)。<br />チェックを入れると該当するアイテムは強制的に配置または上書きされます。");
