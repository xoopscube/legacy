...
require_once XUPDATE_TRUST_PATH . '/class/AbstractDeleteAction.class.php';

/**
 * Xupdate_StoreDeleteAction
**/
class Xupdate_StoreDeleteAction extends Xupdate_AbstractDeleteAction
{
    /**
     * _getId
     * 
    ...
    **/
    ...
    {
        $this->mActionForm =& $this->mAsset->getObject('form', 'Store',false,'delete');
