...
define('_MD_PROTECTOR_DENYBYMULTIBYTE','投稿内容がASCIIキャラクターのみのため、SPAMだと判断されました。') ;
define('_MD_PROTECTOR_FMT_REGISTER_MORATORIUM','SPAM防止のためにユーザ登録直後のURL付投稿はお断りしています。お手数ですが%s分後に再度投稿してください。') ;
define('_MD_PROTECTOR_MANIPUNOTIFYSBJ','Protectorからの変更通知') ;
define('_MD_PROTECTOR_FMT_MANIPUNOTIFYBODY','%s\n\nサイトのルート部分になんらかの変更が加えられました。\n万一、この変更に覚えがない場合はワームや第三者による改ざんの可能性もあります。') ;
