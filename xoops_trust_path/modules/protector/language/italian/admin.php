...
define("_AM_ADV_MAINUNPATCHED","E' necessario modificare il file mainfile.php come scritto nel README.");

define("_AM_ADV_SUBTITLECHECK","Controlla se il Protector funziona correttamente");
