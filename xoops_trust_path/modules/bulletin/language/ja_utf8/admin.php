...
define('_AM_WAYSYWTDTTAL','このカテゴリおよびこのカテゴリ内の全てのコンテンツおよびコメントを削除してもいいですか？');
...
define('_AM_PUB_ARTICLES','掲載中のコンテンツ');
define('_AM_WAITING_ARTICLES','承認待ちのコンテンツ');
...
define('_AM_EDIT_ARTICLE','コンテンツの編集');
