...
define('_MD_D3PIPES_JOINT_PARSE','Analisando o XML');
define('_MD_D3PIPES_JOINT_CACHE','Cache');
define('_MD_D3PIPES_JOINT_PING','Atualização do Ping');
define('_MD_D3PIPES_JOINT_UTF8TO','Transferir codificação do UTF-8');
define('_MD_D3PIPES_JOINT_UTF8FROM','Transferir codificação para UTF-8');
define('_MD_D3PIPES_JOINT_REPLACE','Substituir texto');
define('_MD_D3PIPES_JOINT_CLIP','Clipping local');
...
define('_MD_D3PIPES_N4J_CACHE','Informe o tempo em cache (seg)');
define('_MD_D3PIPES_N4J_UTF8TO','Normalmente, informe a códificação interna');
...
define('_MD_D3PIPES_N4J_CLIPLIFETIME','Tempo de vida dos clippings (usa preferências, se branco)');
define('_MD_D3PIPES_N4J_WITHDESCRIPTION','Obter a descrição também');
define('_MD_D3PIPES_N4J_REPLACEFROM','busca');
define('_MD_D3PIPES_N4J_REPLACETO','substituição');
define('_MD_D3PIPES_N4J_XSLTPATH','Percurso para XSLT (url ou físico)');

define('_MD_D3PIPES_CLASS_FETCHSNOOPY','por Snoopy (recomendado)');
define('_MD_D3PIPES_CLASS_FETCHFOPEN','por URL fopen');
define('_MD_D3PIPES_CLASS_PARSEKEITHXML','KeithXML (recomendado)');
define('_MD_D3PIPES_CLASS_PARSESIMPLEHTML','HTML parser por &lt;hn&gt; tag');
define('_MD_D3PIPES_CLASS_PARSELINKHTML','HTML parser by &lt;a&gt; tag');
define('_MD_D3PIPES_CLASS_FILTERPCRE','Selecionar por regex de pcre');
define('_MD_D3PIPES_CLASS_FILTERPCRE_EXCEPT','Excluir por regex do pcre');
define('_MD_D3PIPES_CLASS_FILTERMBREGEX','Selecionar por mbregex');
define('_MD_D3PIPES_CLASS_FILTERMBREGEX_EXCEPT','Excluir por mbregex');
define('_MD_D3PIPES_CLASS_CLIPMODULEDB','Manter no banco de dados');
define('_MD_D3PIPES_CLASS_REASSIGNCONTENTENCODED','descrição do conteúdo');
define('_MD_D3PIPES_CLASS_REASSIGNALLOWHTML','Permitir HTML');
define('_MD_D3PIPES_CLASS_REASSIGNSTRIPTAGS','Retirar tags HTML');
define('_MD_D3PIPES_CLASS_REASSIGNDEFAULTLINK','Especificar URL do link');
define('_MD_D3PIPES_CLASS_REASSIGNHTMLENTITYDECODE','Fixar extra entidade html');
...
define('_MD_D3PIPES_MSG_CLIPPINGUPDATED','O Clipping foi atualizado com sucesso');
define('_MD_D3PIPES_MSG_CLIPPINGDELETED','O Clipping foi deletado com sucesso');
...
define('_MD_D3PIPES_ERR_URLFOPENINFETCH','Você não pode usar "fopen" sob allow_url_fopen=off');
define('_MD_D3PIPES_ERR_INVALIDDIRNAMEINBLOCK','Nome do diretório inválido no bloco conjunto');
define('_MD_D3PIPES_ERR_INVALIDFILEINBLOCK','Blockfile inválido no bloco conjunto');
define('_MD_D3PIPES_ERR_INVALIDFUNCINBLOCK','Blockfunc inválido no bloco conjunto');
