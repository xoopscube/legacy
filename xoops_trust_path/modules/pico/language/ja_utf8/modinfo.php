...
if ( defined( 'FOR_XOOPS_LANG_CHECKER' ) || ! defined( $constpref . '_LOADED' ) ) {
    ...
    // admin menus
    define( $constpref . '_ADMENU_ACTIVITY', '活動概要' );
    ...
    define( $constpref . '_ERR_DOCUMENT_404DSC', '対象ページが見つからず、404 エラーとなった場合に表示するコンテンツファイルへのパス。<br/>冒頭での "xoops_root_path" は "' . XOOPS_ROOT_PATH . '"/404.html に、"xoops_trust_path" は "' . XOOPS_TRUST_PATH . '" と解釈されます。' );
