...
define( '_MD_PICO_REVISIONS' , 'Revisions');
define( '_MD_PICO_HISTORY' , 'Revision Histories');
define( '_MD_PICO_DIFF2NOW' , 'Diff to current');
define( '_MD_PICO_DIFFFROMPREV' , 'Diff from previous');
define( '_MD_PICO_REFERIT' , 'Refer');
...
define( '_MD_PICO_ERR_LOCKEDCONTENT' , 'Content locked');
...
define( '_MD_PICO_LABEL_COMMENTS' , 'Comments');
