...
'upload_ng'        => 'Upload fehlgeschlagen.',
'maketmp_ng'       => 'Generierung des temporären Files fehlgeschlagen.',
'file_notfound'    => 'Eine Datei wurde nicht gefunden.',
'tarfile_notfound' => 'Keine Datei für "untar" gefunden.',
'filelist'         => 'Liste der "untared" Dateien',
'data_download'    => 'Download von Daten',
'file'             => 'Datei:',
'tar_type'         => 'Archive Typ',
'tar.gz'           => '*.tar.gz',
'tar'              => '*.tar',
'backup_dir'       => 'Backup Ordner',
'option'           => 'Option',
'decode_pagename'  => 'Decodiere den Seitennamen mit dem Ordnerpfad.
 (Dies läßt sich nicht rückgängig machen und einige Buchstaben werden durch \'_\' ersetzt.)',
'admin_pass'       => 'Passwort des Administrators',
'password_ng'      => 'das Passwort ist unterschiedlich.',
'data_restore'     => 'Stelle Daten wieder her (*.tar, *.tar.gz)',
'data_overwrite'   => '[Warnung] Daten werden überschrieben (please warn a data file of the same name enough).',
'max_filesize'     => 'Die maximale Dateigröße ist $maxsize KByte.',
