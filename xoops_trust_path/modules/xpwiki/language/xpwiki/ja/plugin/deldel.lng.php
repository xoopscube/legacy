...
$msg = array(
	...
	'title_delete_referer' => '参照元情報を一括削除しました',
	...
	'msg_together_flag'	   => '同時に、該当ページのバックアップ・差分・カウンター・添付ファイル・参照元情報 も削除する。',
	'msg_together_confirm' => '同時に、該当ページのバックアップ・差分・カウンター・添付ファイル・参照元情報 も削除するように設定されています。',
	'msg_together'		   => '同時に該当ページのバックアップ・差分・カウンター・添付ファイル・参照元情報 も削除しました。',
	'msg_auth_error'	   => '管理者権限がありません。管理者としてログインしてください。',
	'msg_delete_error'	   => '削除しようとしたファイルはもう既にないか、移動先に同名ページがあるなど、何らかの理由で削除できませんでした。確認して下さい。',
	'msg_delete_success'   => '以上のファイルを削除しました。',
	'msg_fatal_error'	   => '何か変です！何が変かはわかりません。',
	'msg_back_word'		   => '戻る',
	'msg_back_dbsync'	   => 'ここをクリックして、移動先 xpWiki のデータベースシンクロを実行してください。',
	'msg_regexp_label'	   => '削除ページ名のパターン(正規表現)：',
	'msg_regexp_error'	   => 'このパターンを含むページはありませんでした。',
	'msg_is_freezed'	   => '<span class="new1"> * </span>は凍結されているページです。(ページは削除できません)',
	'msg_is_deleted'	   => '<span class="diff_added"> # </span>は元ページが削除されているファイルです。',
	'msg_move_flag'        => '次のディレクトリの xpWiki にコピーしてから削除する。-> ',
	'btn_exec'			   => '削除',
	'btn_search'		   => '検索',
	'btn_research'		   => '再検索',
	'btn_concern'		   => '確認'
