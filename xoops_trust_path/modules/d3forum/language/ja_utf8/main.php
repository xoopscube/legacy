...
define( '_MD_D3FORUM_MARKEDYES_DESC' , 'あなたはこのトピックを - 投稿一覧画面でこのトピックは更新日時に関わらず、常に上の方に表示されます 注目トピック - にしています');
define( '_MD_D3FORUM_MARKEDNO_DESC' , 'このトピックを - 投稿一覧画面やブロック等で最上位に表示されます 注目トピック - にすることができます');
define( '_MD_D3FORUM_ALT_SOLVEDYES' , '解決済トピック');
define( '_MD_D3FORUM_ALT_SOLVEDNO' , '未解決トピック');
define( '_MD_D3FORUM_SOLVEDYES_DESC' , 'このトピックは - 管理者、モデレータによって、話題が解決しているとされています - 解決済みトピック - です');
define( '_MD_D3FORUM_SOLVEDNO_DESC' , 'このトピックは - 話題への回答をまだ募集している状態です。未解決トピック - です');
...
define( '_MD_D3FORUM_MSG_NOMATCH' , '検索条件に一致するデータは見つかりませんでした<br>検索キーワードに誤字脱字がないか確認してください。<br>より一般的な用語を使用してください。');
