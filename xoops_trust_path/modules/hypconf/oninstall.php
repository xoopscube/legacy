...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return hypconf_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'hypconf_oninstall_base' ) ) {

function hypconf_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'hypconf_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function hypconf_message_append_oninstall( &$module_obj , &$log )
{
