...
define($constpref.'_JQUERY_REMOVE_FLASH' , 'Remove Flash (jqm)');
define($constpref.'_JQUERY_REMOVE_FLASH_DESC' , 'Profile name to remove Flash. Them separated by comma. If the profile name defined in the renderer to mobile phones, "docomo, au, softbank, willcom, android, iphone, ipod, ipad, and windows mobile" you can use.');
define($constpref.'_JQUERY_RESOLVE_TABLE' , 'Expand nested table (jqm)');
define($constpref.'_JQUERY_RESOLVE_TABLE_DESC' , 'Expand the table that is nested when applying jQuery Mobile.');
define($constpref.'_JQUERY_IMAGE_CONVERT' , 'IMG width max [px] (jqm)');
define($constpref.'_JQUERY_IMAGE_CONVERT_DESC' , 'Shrink Image to specification size(width) at the time of jQuery Mobile application. "0" is disable.');
