...
define('_TPLSADMIN_FMT_MSG_ENCLOSEBYCOMMENT', '%d ذخیره‌سازِ الگو با نظرات مدیر الگوها بسته شدند') ;
define('_TPLSADMIN_DT_ENCLOSEBYCOMMENT', 'القا کردن نظرات') ;
...
define('_TPLSADMIN_DT_REMOVEHOOKS', 'معمولی‌سازی پرونده‌های ذخیره‌ساز الگوها') ;
...
define('_TPLSADMIN_CNF_REMOVEHOOKS', 'آیا با معمولی‌سازی موافقت می کنید؟') ;


define('_TPLSADMIN_MSG_CLEARCACHE', 'ذحیره‌ساز الگو پاک شد') ;
...
define('_TPLSADMIN_FMT_MSG_PUTTEMPLATES', '%d الگو وارد شد.') ;
define('_TPLSADMIN_DT_PUTTEMPLATES', 'بارگذاری الگو') ;
...
define('_TPLSADMIN_ERR_NOTUPLOADED', 'هیچ فایلی بارگذاری نشده است') ;
define('_TPLSADMIN_ERR_EXTENSION', 'این پسوند قابل تشخیص نمی باشد.') ;
define('_TPLSADMIN_ERR_INVALIDARCHIVE', 'این آرشیو قابل استخراج شدن نمی باشد.') ;
define('_TPLSADMIN_ERR_INVALIDTPLSET', 'نام دسته غیر مجاز می باشد.') ;

define('_TPLSADMIN_ERR_NOTPLSVARSINFO', 'هیچ پرونده‌ای برای اطلاعات متغیرهای الگوها وجود ندارد.') ;

define('_TPLSADMIN_NUMCAP_COMPILEDCACHES', 'ذحیره‌سازی‌های الگو گردآوری شدند') ;
define('_TPLSADMIN_NUMCAP_TPLSVARS', 'پرونده‌های اطلاعات متغیرهای الگوها') ;
