...
define( '_MD_A_MYBLOCKSADMIN_SBLEFT' , '左');
define( '_MD_A_MYBLOCKSADMIN_SBRIGHT' , '右');
define( '_MD_A_MYBLOCKSADMIN_CBLEFT' , '中央左');
define( '_MD_A_MYBLOCKSADMIN_CBRIGHT' , '中央右');
define( '_MD_A_MYBLOCKSADMIN_CBCENTER' , '中央');
...
define( '_MD_A_MYBLOCKSADMIN_PERMADDNGP' , 'このアイテムの上位アイテム全てにパーミッションを与える必要があります');
